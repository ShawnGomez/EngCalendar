...
//#endregion
//#region node_modules/tui-time-picker/dist/tui-time-picker.js
var require_tui_time_picker = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __webpack_require__(moduleId) {
				...
				var module$65 = installedModules[moduleId] = {
					i: moduleId,
					l: false,
					exports: {}
				};
				modules[moduleId].call(module$65.exports, module$65, module$65.exports, __webpack_require__);
				module$65.l = true;
				return module$65.exports;
			}
			__webpack_require__.m = modules;
			__webpack_require__.c = installedModules;
			__webpack_require__.d = function(exports$65, name, getter) {
				if (!__webpack_require__.o(exports$65, name)) Object.defineProperty(exports$65, name, {
					enumerable: true,
					get: getter
				});
			};
			__webpack_require__.r = function(exports$66) {
				if (typeof Symbol !== "undefined" && Symbol.toStringTag) Object.defineProperty(exports$66, Symbol.toStringTag, { value: "Module" });
			...
			__webpack_require__.n = function(module$66) {
				var getter = module$66 && module$66.__esModule ? function getDefault() {
					return module$66["default"];
			...
			(function(module$67, exports$67, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$67.exports = inArray;
			}),
			(function(module$68, exports$68, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$68.exports = forEachArray;
			}),
			(function(module$69, exports$69, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$69.exports = extend;
			}),
			(function(module$70, exports$70, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$70.exports = isArray;
			}),
			(function(module$71, exports$71, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$71.exports = forEach;
			}),
			(function(module$72, exports$72, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$72.exports = isUndefined;
			}),
			(function(module$73, exports$73, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$73.exports = isString;
			}),
			(function(module$74, exports$74, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$74.exports = template;
			}),
			(function(module$75, exports$75, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				CustomEvents.prototype.off = function(eventName, handler) {
					if (isString(eventName)) this._offByEventName(eventName, handler);
					else if (!arguments.length) {
						this.events = {};
						this.contexts = [];
					} else if (isFunction(eventName)) this._offByHandler(eventName);
					else if (isObject(eventName)) this._offByObject(eventName, handler);
				};
				/**
				* Fire custom event
				...
				*/
				...
				module$75.exports = CustomEvents;
			}),
			(function(module$76, exports$76, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview
				...
				*/
				...
				module$76.exports = defineClass;
			}),
			(function(module$77, exports$77, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$77.exports = on;
			}),
			(function(module$78, exports$78, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function removeHandler(element, type, handler) {
					if ("removeEventListener" in element) element.removeEventListener(type, handler);
					else if ("detachEvent" in element) element.detachEvent("on" + type, handler);
				}
				module$78.exports = off;
			}),
			(function(module$79, exports$79, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$79.exports = closest;
			}),
			(function(module$80, exports$80, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$80.exports = removeElement;
			}),
			(function(module$81, exports$81, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$81.exports = isHTMLNode;
			}),
			(function(module$82, exports$82, __webpack_require__) {
				"use strict";
				var inArray = __webpack_require__(0);
				var forEachArray = __webpack_require__(1);
				...
				module$82.exports = {
					...
					getRangeArr: function(start, end, step) {
						...
						var i;
						step = step || 1;
						if (start > end) for (i = end; i >= start; i -= step) arr.push(i);
						else for (i = start; i <= end; i += step) arr.push(i);
						return arr;
					},
					fill: function(start, end, value, target) {
						...
						var i;
						for (i = start; i <= replaceEnd; i += 1) arr[i] = value;
						for (i = replaceEnd; i <= end; i += 1) arr.push(value);
						return arr;
					},
			...
			(function(module$83, exports$83, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$83.exports = forEachOwnProperties;
			}),
			(function(module$84, exports$84, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$84.exports = safeEvent;
			}),
			(function(module$85, exports$85, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$85.exports = getClass;
			}),
			(function(module$86, exports$86, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$86.exports = setClassName;
			}),
			(function(module$87, exports$87, __webpack_require__) {
				"use strict";
				__webpack_require__(21);
				module$87.exports = __webpack_require__(22);
			}),
			(function(module$88, exports$88, __webpack_require__) {}),
			(function(module$89, exports$89, __webpack_require__) {
				"use strict";
				var inArray = __webpack_require__(0);
				var forEachArray = __webpack_require__(1);
				...
				*/
					...
					/** @lends TimePicker.prototype */
					{
						...
						init: function(container, options) {
							...
							*/
							...
							this.render();
							this.setEvents();
							if (options.usageStatistics) util.sendHostName();
						},
						setEvents: function() {
							this.hourInput.on("change", this.onChangeTimeInput, this);
							this.minuteInput.on("change", this.onChangeTimeInput, this);
							if (this.showMeridiem) {
								if (this.inputType === INPUT_TYPE_SELECTBOX) on(this.meridiemElement.querySelector("select"), "change", this.onChangeMeridiem, this);
								else if (this.inputType === INPUT_TYPE_SPINBOX) on(this.meridiemElement, "click", this.onChangeMeridiem, this);
							}
						},
						removeEvents: function() {
							...
							if (this.showMeridiem) {
								if (this.inputType === INPUT_TYPE_SELECTBOX) off(this.meridiemElement.querySelector("select"), "change", this.onChangeMeridiem, this);
								else if (this.inputType === INPUT_TYPE_SPINBOX) off(this.meridiemElement, "click", this.onChangeMeridiem, this);
							}
						},
						render: function() {
							var context = {
							...
							if (this.showMeridiem) extend(context, { meridiemElement: this.makeMeridiemHTML() });
							...
							if (this.showMeridiem) this.setMeridiemElement();
						},
						setMeridiemElement: function() {
							if (this.meridiemPosition === "left") addClass(this.element, CLASS_NAME_LEFT_MERIDIEM);
						...
						renderTimeInputs: function() {
							...
							if (showMeridiem) hour = util.getMeridiemHour(hour);
						...
						makeDisabledStatItems: function(hourItems) {
							...
							if (this.showMeridiem) disabledHours = this.meridiemableTime(disabledHours);
						...
						meridiemableTime: function(disabledHours) {
							...
							forEachArray(disabledHours, function(hour) {
								if (hour >= startHour && hour <= endHour) result.push(hour - diffHour === 0 ? 12 : hour - diffHour);
							});
							return result;
						},
						getValidTimeFormat: function(format) {
							if (!format.match(/^[h]{1,2}:[m]{1,2}$/i)) return "h:m";
						...
						syncToInputs: function() {
							...
							if (this.showMeridiem) hour = util.getMeridiemHour(hour);
						...
						onChangeTimeInput: function() {
							...
							if (this.showMeridiem) hour = this.to24Hour(isPM, hour);
						...
						setDisabledMinutes: function(hour) {
							var disabledItems = this.disabledMinutes[hour] || [];
						...
						setTime: function(hour, minute, silent) {
							if (!this.validItems(hour, minute)) return;
							this.hour = hour;
							this.minute = minute;
							this.syncToInputs();
							if (this.showMeridiem) this.syncToMeridiemElements();
							/**
						...
						setRange: function(begin, end) {
							...
							var endHour, endMin;
							if (!this.isValidRange(begin, end)) return;
							if (end) {
								endHour = end.hour;
								endMin = end.minute;
							}
						...
						setRangeHour: function(beginHour, endHour) {
							...
							if (endHour) disabledHours = disabledHours.concat(util.getRangeArr(endHour + 1, END_NUMBER_OF_HOUR));
							this.disabledHours = disabledHours.slice();
						},
						setRangeMinute: function(beginHour, beginMin, endHour, endMin) {
							var disabledMinRanges = [];
							if (!beginHour && !beginMin) return;
						...
						resetMinuteRange: function() {
							...
							for (i = 0; i <= END_NUMBER_OF_HOUR; i += 1) this.setDisabledMinutes(this.hour);
						},
						isValidRange: function(begin, end) {
							var beginHour = begin.hour;
							var beginMin = begin.minute;
							var endHour, endMin;
							if (!this.isValidTime(beginHour, beginMin)) return false;
							if (!end) return true;
							endHour = end.hour;
							endMin = end.minute;
				...
				module$89.exports = TimePicker;
			}),
			(function(module$90, exports$90, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$90.exports = isExisty;
			}),
			(function(module$91, exports$91, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$91.exports = isNull;
			}),
			(function(module$92, exports$92, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$92.exports = isObject;
			}),
			(function(module$93, exports$93, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$93.exports = isFunction;
			}),
			(function(module$94, exports$94, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$94.exports = inherit;
			}),
			(function(module$95, exports$95, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$95.exports = createObject;
			}),
			(function(module$96, exports$96, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$96.exports = addClass;
			}),
			(function(module$97, exports$97, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$97.exports = matches;
			}),
			(function(module$98, exports$98, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$98.exports = toArray;
			}),
			(function(module$99, exports$99, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function removeClass(element) {
					...
					forEachArray(origin, function(name) {
						if (inArray(name, cssClass) < 0) newClass.push(name);
					});
					setClassName(element, newClass);
				}
				module$99.exports = removeClass;
			}),
			(function(module$100, exports$100, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$100.exports = isNumber;
			}),
			(function(module$101, exports$101, __webpack_require__) {
				"use strict";
				var inArray = __webpack_require__(0);
				var forEachArray = __webpack_require__(1);
				var CustomEvents = __webpack_require__(8);
				...
				*/
				var Spinbox = defineClass(
					/** @lends Spinbox.prototype */
					{
						...
						_render: function() {
							...
							var context;
							if (this._disabledItems[index]) this._selectedIndex = this._findEnabledIndex();
							context = {
						...
						_onClickHandler: function(ev) {
							var target = util.getTarget(ev);
							if (closest(target, SELECTOR_DOWN_BUTTON)) this._setNextValue(true);
							else if (closest(target, SELECTOR_UP_BUTTON)) this._setNextValue(false);
						},
						_setNextValue: function(isDown) {
							var index = this._selectedIndex;
							if (isDown) index = index ? index - 1 : this._items.length - 1;
							else index = index < this._items.length - 1 ? index + 1 : 0;
							if (this._disabledItems[index]) {
								this._selectedIndex = index;
								this._setNextValue(isDown);
							} else this.setValue(this._items[index]);
						},
						...
						_onChangeHandler: function(ev) {
							if (closest(util.getTarget(ev), "input")) this._changeToInputValue();
						},
						_changeToInputValue: function(silent) {
							...
							if (newIndex === -1) this.setValue(this._items[this._selectedIndex], silent);
							else {
								this._selectedIndex = newIndex;
								if (!silent) this.fire("change", { value: newValue });
							}
						},
				...
				module$101.exports = Spinbox;
			}),
			(function(module$102, exports$102, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function isExpired(date) {
					return (/* @__PURE__ */ new Date()).getTime() - date > ms7days;
				}
				/**
				...
				*/
				...
				module$102.exports = sendHostname;
			}),
			(function(module$103, exports$103, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$103.exports = imagePing;
			}),
			(function(module$104, exports$104, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(7);
				module$104.exports = function(context) {
					return template("<div class=\"tui-timepicker-btn-area\">  <input type=\"text\" class=\"tui-timepicker-spinbox-input\"        maxlength=\"{{maxLength}}\"        size=\"{{maxLength}}\"        value=\"{{formatTime initialValue format}}\"        aria-label=\"TimePicker spinbox value\">  <button type=\"button\" class=\"tui-timepicker-btn tui-timepicker-btn-up\">    <span class=\"tui-ico-t-btn\">Increase</span>  </button>  <button type=\"button\" class=\"tui-timepicker-btn tui-timepicker-btn-down\">    <span class=\"tui-ico-t-btn\">Decrease</span>  </button></div>", context);
				};
			}),
			(function(module$105, exports$105, __webpack_require__) {
				"use strict";
				var inArray = __webpack_require__(0);
				var CustomEvents = __webpack_require__(8);
				var defineClass = __webpack_require__(9);
				...
				*/
				var Selectbox = defineClass(
					/** @lends Selectbox.prototype */
					{
						...
						_changeEnabledIndex: function() {
							var index = inArray(this.getValue(), this._items);
							if (this._disabledItems[index]) this._selectedIndex = inArray(false, this._disabledItems);
						},
						setDisabledItems: function(disabledItems) {
							this._disabledItems = disabledItems;
							this._render();
						...
						_onChangeHandler: function(ev) {
							if (closest(util.getTarget(ev), "select")) this._setNewValue();
						},
				...
				module$105.exports = Selectbox;
			}),
			(function(module$106, exports$106, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(7);
				module$106.exports = function(context) {
					return template("<select class=\"tui-timepicker-select\" aria-label=\"Time\">  {{each items}}    {{if equals initialValue @this}}      <option value=\"{{@this}}\" selected {{if disabledItems[@index]}}disabled{{/if}}>{{formatTime @this format}}</option>    {{else}}      <option value=\"{{@this}}\" {{if disabledItems[@index]}}disabled{{/if}}>{{formatTime @this format}}</option>    {{/if}}  {{/each}}</select>", context);
				};
			}),
			(function(module$107, exports$107, __webpack_require__) {
				"use strict";
				module$107.exports = {
					en: {
						am: "AM",
			...
			(function(module$108, exports$108, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(7);
				module$108.exports = function(context) {
					return template("<div class=\"tui-timepicker\">  <div class=\"tui-timepicker-body\">    <div class=\"tui-timepicker-row\">      {{if isSpinbox}}        <div class=\"tui-timepicker-column tui-timepicker-spinbox tui-timepicker-hour\"></div>        <span class=\"tui-timepicker-column tui-timepicker-colon\"><span class=\"tui-ico-colon\">:</span></span>        <div class=\"tui-timepicker-column tui-timepicker-spinbox tui-timepicker-minute\"></div>        {{if showMeridiem}}          {{meridiemElement}}        {{/if}}      {{else}}        <div class=\"tui-timepicker-column tui-timepicker-selectbox tui-timepicker-hour\"></div>        <span class=\"tui-timepicker-column tui-timepicker-colon\"><span class=\"tui-ico-colon\">:</span></span>        <div class=\"tui-timepicker-column tui-timepicker-selectbox tui-timepicker-minute\"></div>        {{if showMeridiem}}          {{meridiemElement}}        {{/if}}      {{/if}}    </div>  </div></div>", context);
				};
			}),
			(function(module$109, exports$109, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(7);
				module$109.exports = function(context) {
					return template("{{if isSpinbox}}  <div class=\"tui-timepicker-column tui-timepicker-checkbox tui-timepicker-meridiem\">    <div class=\"tui-timepicker-check-area\">      <ul class=\"tui-timepicker-check-lst\">        <li class=\"tui-timepicker-check\">          <div class=\"tui-timepicker-radio\">            <input type=\"radio\"                  name=\"optionsRadios-{{radioId}}\"                  value=\"AM\"                  class=\"tui-timepicker-radio-am\"                  id=\"tui-timepicker-radio-am-{{radioId}}\">            <label for=\"tui-timepicker-radio-am-{{radioId}}\" class=\"tui-timepicker-radio-label\">              <span class=\"tui-timepicker-input-radio\"></span>{{am}}            </label>          </div>        </li>        <li class=\"tui-timepicker-check\">          <div class=\"tui-timepicker-radio\">            <input type=\"radio\"                  name=\"optionsRadios-{{radioId}}\"                  value=\"PM\"                  class=\"tui-timepicker-radio-pm\"                  id=\"tui-timepicker-radio-pm-{{radioId}}\">            <label for=\"tui-timepicker-radio-pm-{{radioId}}\" class=\"tui-timepicker-radio-label\">              <span class=\"tui-timepicker-input-radio\"></span>{{pm}}            </label>          </div>        </li>      </ul>    </div>  </div>{{else}}  <div class=\"tui-timepicker-column tui-timepicker-selectbox tui-is-add-picker tui-timepicker-meridiem\">    <select class=\"tui-timepicker-select\" aria-label=\"AM/PM\">      <option value=\"AM\">{{am}}</option>      <option value=\"PM\">{{pm}}</option>    </select>  </div>{{/if}}", context);
				};
			})
		]);
	});
...
//#endregion
//#region node_modules/@toast-ui/calendar/dist/toastui-calendar.mjs
var import_tui_date_picker = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	*/
	(function webpackUniversalModuleDefinition(root, factory) {
		if (typeof exports === "object" && typeof module === "object") module.exports = factory(require_tui_time_picker());
		else if (typeof define === "function" && define.amd) define(["tui-time-picker"], factory);
		else if (typeof exports === "object") exports["DatePicker"] = factory(require_tui_time_picker());
		...
		return (function(modules) {
			...
			(function(module$3, exports$3, __webpack_require__) {
				...
				*/
				...
				module$3.exports = defineClass;
			}),
			(function(module$4, exports$4, __webpack_require__) {
				"use strict";
				/**
			...
			(function(module$5, exports$5, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Execute the provided callback once for each element present in the array(or Array-like object) in ascending order.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$7.exports = {
					...
					getSelector: function(elem) {
						...
						else if (elem.className) selector = "." + elem.className.split(" ")[0];
						return selector;
					},
					generateId: function() {
						currentId += 1;
				...
				*/
				var utils = {
					...
					getSafeNumber: function(any, defaultNumber) {
						if (isNaN(defaultNumber) || !isNumber(defaultNumber)) throw Error("The defaultNumber must be a valid number.");
						if (isNaN(any)) return defaultNumber;
						return Number(any);
					},
					getDateOfWeek: function(year, month, weekNumber, dayNumber) {
						var dateOffset = new Date(year, month - 1).getDay() - dayNumber - 1;
						return new Date(year, month - 1, weekNumber * 7 - dateOffset);
					},
					getRangeArr: function(start, end) {
						var arr = [];
						var i;
						if (start > end) for (i = end; i >= start; i -= 1) arr.push(i);
						else for (i = start; i <= end; i += 1) arr.push(i);
						return arr;
					},
					...
					compare: function(dateA, dateB, cmpLevel) {
						...
						if (!(utils.isValidDate(dateA) && utils.isValidDate(dateB))) return NaN;
						if (!cmpLevel) {
			...
			(function(module$11, exports$11, __webpack_require__) {
				...
				*/
				...
				module$11.exports = CustomEvents;
			}),
			...
			(function(module$17, exports$17, __webpack_require__) {
				...
				*/
				...
				module$17.exports = removeElement;
			}),
			(function(module$18, exports$18, __webpack_require__) {
				...
				*/
				...
				module$18.exports = isNumber;
			}),
			(function(module$19, exports$19, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Add css class to element
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$19.exports = addClass;
			}),
			(function(module$20, exports$20, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Get HTML element's design classes.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$20.exports = getClass;
			}),
			(function(module$21, exports$21, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Remove css class from element
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$21.exports = removeClass;
			}),
			(function(module$22, exports$22, __webpack_require__) {
				"use strict";
				/**
			...
			(function(module$23, exports$23, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$23.exports = LayerBase;
			}),
			(function(module$24, exports$24, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				var mergeDefaultOption = function(option) {
					...
					if (!isObject(option.calendar)) throw new Error("Calendar option must be an object");
				...
				*/
					...
					/** @lends DatePicker.prototype */
					{
						...
						init: function(container, options) {
							...
							*/
							...
							this._container.innerHTML = tmpl(extend(options, { isTab: options.timePicker && options.timePicker.layoutType === "tab" }));
							/**
							* DatePicker element
							* @type {HTMLElement}
							* @private
						...
						_initializeDatePicker: function(option) {
							...
							if (!this.showAlways) this._hide();
							if (this.getType() === TYPE_DATE) addClass(this._element.querySelector(SELECTOR_BODY), "tui-datepicker-type-date");
						},
						_setEvents: function() {
						...
						_initTimePicker: function(opTimePicker, usageStatistics) {
							var layoutType;
							if (!opTimePicker) return;
							layoutType = opTimePicker.layoutType || "";
							if (isObject(opTimePicker)) opTimePicker.usageStatistics = usageStatistics;
							else opTimePicker = { usageStatistics };
							this._timePicker = new TimePicker(this._element.querySelector(SELECTOR_TIMEPICKER_CONTAINER), opTimePicker);
							if (layoutType.toLowerCase() === "tab") this._timePicker.hide();
						...
						_changePicker: function(target) {
							var selectedBtn = closest(target, "." + CLASS_NAME_SELECTOR_BUTTON);
							if (!!selectedBtn.querySelector(SELECTOR_DATE_ICO)) {
								this._calendar.show();
						...
						_isOpener: function(element) {
							return inArray(util.getElement(element), this._openers) > -1;
						},
						_setTodayClassName: function(el) {
							var timestamp, isToday;
							if (this.getCalendarType() !== TYPE_DATE) return;
							timestamp = Number(getData(el, "timestamp"));
							isToday = timestamp === (/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0);
							if (isToday) addClass(el, CLASS_NAME_TODAY);
							else removeClass(el, CLASS_NAME_TODAY);
						},
						...
						_setSelectedClassName: function(el) {
							var elDate = new Date(Number(getData(el, "timestamp")));
							if (this._isSelectedOnCalendar(elDate)) addClass(el, CLASS_NAME_SELECTED);
							else removeClass(el, CLASS_NAME_SELECTED);
						},
						...
						_syncFromInput: function(shouldRollback) {
							...
							try {
								...
								if (this.isSelectable(date)) {
									if (this._timePicker) this._timePicker.setTime(date.getHours(), date.getMinutes());
									this.setDate(date);
								} else isFailed = true;
							} catch (err) {
								this.fire("error", {
								...
								if (isFailed) if (shouldRollback) this._syncToInput();
								else this.setNull();
							}
						},
						_onMousedownDocument: function(ev) {
							...
							if (!(this.showAlways || isInput || isContain || isInOpener)) this.close();
						},
						_onClickHandler: function(ev) {
							var target = util.getTarget(ev);
							...
							} else if (closest(target, SELECTOR_CALENDAR_TITLE)) this.drawUpperCalendar(this._date);
							else if (closest(target, "." + CLASS_NAME_SELECTOR_BUTTON)) this._changePicker(target);
						},
						...
						_updateDate: function(target) {
							...
							if (this.getCalendarType() !== this.getType()) this.drawLowerCalendar(newDate);
							else {
								if (timePicker) newDate.setHours(timePicker.getHour(), timePicker.getMinute());
								else if (prevDate) newDate.setHours(prevDate.getHours(), prevDate.getMinutes());
								this.setDate(newDate);
								if (!this.showAlways && this.autoClose) this.close();
							}
						},
						...
						_setDisplay: function(el, shouldShow) {
							if (el) if (shouldShow) removeClass(el, CLASS_NAME_HIDDEN);
							else addClass(el, CLASS_NAME_HIDDEN);
						},
						...
						_refreshFromRanges: function() {
							if (!this.isSelectable(this._date)) this.setNull();
							else this._calendar.draw();
						},
						...
						open: function() {
							if (this.isOpened() || !this._isEnabled) return;
							this._calendar.draw({
								date: this._date,
								type: this._type
							});
							this._show();
							if (!this.showAlways) this._setDocumentEvents();
							/**
						...
						drawUpperCalendar: function(date) {
							var calendarType = this.getCalendarType();
							if (calendarType === TYPE_DATE) this._calendar.draw({
								date,
								type: TYPE_MONTH
							});
							else if (calendarType === TYPE_MONTH) this._calendar.draw({
								date,
								type: TYPE_YEAR
							});
						},
						drawLowerCalendar: function(date) {
							var calendarType = this.getCalendarType();
							if (calendarType === this.getType()) return;
							if (calendarType === TYPE_MONTH) this._calendar.draw({
								date,
								type: TYPE_DATE
							});
							else if (calendarType === TYPE_YEAR) this._calendar.draw({
								date,
								type: TYPE_MONTH
							});
						},
						...
						setDate: function(date, silent) {
							...
							if (shouldUpdate) {
								...
								if (this._timePicker) this._timePicker.setTime(newDate.getHours(), newDate.getMinutes(), true);
								this._syncToInput();
								/**
						...
						setNull: function() {
							...
							this._date = null;
							if (this._datepickerInput) this._datepickerInput.clearText();
							if (this._timePicker) this._timePicker.setTime(0, 0);
							if (!this.isSelectable(calendarDate)) this._calendar.draw({ date: new Date(this._rangeModel.getMinimumValue()) });
							else this._calendar.draw();
							if (isChagned) this.fire("change");
						},
						...
						setInput: function(element, options) {
							...
							if (options.syncFromInput) this._syncFromInput();
							else this._syncToInput();
						},
						enable: function() {
						...
						changeLanguage: function(language) {
							...
							if (this._timePicker) this._timePicker.changeLanguage(this._language);
						},
						destroy: function() {
							this._removeDocumentEvents();
							this._calendar.destroy();
							if (this._timePicker) this._timePicker.destroy();
				...
				module$24.exports = DatePicker;
			}),
			(function(module$25, exports$25, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check whether the given variable is an object or not.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$25.exports = isObject;
			}),
			(function(module$26, exports$26, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Execute the provided callback once for each property of object which actually exist.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$26.exports = forEachOwnProperties;
			}),
			(function(module$27, exports$27, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Set className value
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$27.exports = setClassName;
			}),
			(function(module$28, exports$28, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Find parent element recursively
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$28.exports = closest;
			}),
			(function(module$29, exports$29, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$29.exports = getData;
			}),
			(function(module$30, exports$30, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$30.exports = hasClass;
			}),
			(function(module$31, exports$31, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$31.exports = isDate;
			}),
			(function(module$32, exports$32, __webpack_require__) {
				"use strict";
				/**
				...
				*/
					...
					/** @lends Calendar.prototype */
					{
						...
						_initHeader: function(options) {
							...
							this._header.on("click", function(ev) {
								var target = util.getTarget(ev);
								if (hasClass(target, CLASS_NAME_PREV_MONTH_BTN)) this.drawPrev();
								else if (hasClass(target, CLASS_NAME_PREV_YEAR_BTN)) this._onClickPrevYear();
								else if (hasClass(target, CLASS_NAME_NEXT_MONTH_BTN)) this.drawNext();
								else if (hasClass(target, CLASS_NAME_NEXT_YEAR_BTN)) this._onClickNextYear();
							}, this);
						},
						...
						_onClickPrevYear: function() {
							if (this.getType() === TYPE_DATE) this.draw({ date: this._getRelativeDate(-12) });
							else this.drawPrev();
						},
						...
						getNextDate: function() {
							if (this.getType() === TYPE_DATE) return this._getRelativeDate(1);
						...
						getNextYearDate: function(customStep) {
							if (customStep) return this._getRelativeDate(customStep);
							switch (this.getType()) {
								case TYPE_DATE:
								case TYPE_MONTH: return this._getRelativeDate(12);
								case TYPE_YEAR: return this._getRelativeDate(108);
				...
				module$32.exports = Calendar;
			}),
			(function(module$33, exports$33, __webpack_require__) {
				"use strict";
				/**
					...
					/** @lends DateTimeFormatter.prototype */
					{
						...
						_parseFormat: function() {
							...
							forEachArray(matchedKeys, function(key, index) {
								if (!/m/i.test(key)) key = key.toLowerCase();
						...
						parse: function(str) {
							...
							if (!matched) throw Error("DateTimeFormatter: Not matched - \"" + str + "\"");
							forEachArray(this._keyOrder, function(name, index) {
								...
								if (name === constants.TYPE_MERIDIEM && /[ap]m/i.test(value)) {
									...
									value = Number(value);
									if (value !== 0 && !value) throw Error("DateTimeFormatter: Unknown value - " + matched[index + 1]);
									if (name === constants.TYPE_YEAR && value < 100) value += 2e3;
									dateHash[name] = value;
								}
							});
							if (hasMeridiem) {
			...
			(function(module$34, exports$34, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Bind DOM events
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$34.exports = on;
			}),
			(function(module$35, exports$35, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Get event collection for specific HTML element
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$35.exports = safeEvent;
			}),
			(function(module$36, exports$36, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Unbind DOM events
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$36.exports = off;
			}),
			(function(module$37, exports$37, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$37.exports = DatePicker;
			}),
			(function(module$38, exports$38, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Provide a simple inheritance in prototype-oriented.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$38.exports = inherit;
			}),
			(function(module$39, exports$39, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Create a new object with the specified prototype object and properties.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$39.exports = createObject;
			}),
			(function(module$40, exports$40, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check whether the given variable is existing or not.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$40.exports = isExisty;
			}),
			(function(module$41, exports$41, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check whether the given variable is null or not.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$41.exports = isNull;
			}),
			(function(module$42, exports$42, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check whether the given variable is a function or not.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$42.exports = isFunction;
			}),
			(function(module$43, exports$43, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check element match selector
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$43.exports = matches;
			}),
			(function(module$44, exports$44, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Transform the Array-like object to Array.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$44.exports = toArray;
			}),
			(function(module$45, exports$45, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$45.exports = convertToKebabCase;
			}),
			(function(module$46, exports$46) {
				module$46.exports = __WEBPACK_EXTERNAL_MODULE__43__;
			}),
			(function(module$47, exports$47, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				var Header = defineClass(
					/** @lends Header.prototype */
					{
						...
						_onClickHandler: function(ev) {
							if (closest(util.getTarget(ev), SELECTOR_BTN)) this.fire("click", ev);
						},
						_getTitleClass: function(type) {
							switch (type) {
								case TYPE_DATE: return CLASS_NAME_TITLE_MONTH;
								case TYPE_MONTH: return CLASS_NAME_TITLE_YEAR;
								case TYPE_YEAR: return CLASS_NAME_TITLE_YEAR_TO_YEAR;
								default: return "";
							}
						},
						_getTitleText: function(date, type) {
							...
							switch (type) {
								case TYPE_DATE: return this._yearMonthTitleFormatter.format(date);
								case TYPE_MONTH: return this._yearTitleFormatter.format(date);
								case TYPE_YEAR:
						...
						render: function(date, type) {
							...
							if (context.showToday) this._infoElement = this._container.querySelector(SELECTOR_INFO_ELEM);
						},
						destroy: function() {
							this._removeEvents();
				...
				module$47.exports = Header;
			}),
			(function(module$48, exports$48, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(11);
				module$48.exports = function(context) {
					return template("{{if isDateCalendar}}  {{if showJumpButtons}}    <div class=\"tui-calendar-header-inner tui-calendar-has-btns\">      <button class=\"tui-calendar-btn tui-calendar-btn-prev-year\">Prev year</button>      <button class=\"tui-calendar-btn tui-calendar-btn-prev-month\">Prev month</button>      <em class=\"tui-calendar-title {{titleClass}}\">{{title}}</em>      <button class=\"tui-calendar-btn tui-calendar-btn-next-month\">Next month</button>      <button class=\"tui-calendar-btn tui-calendar-btn-next-year\">Next year</button>    </div>  {{else}}    <div class=\"tui-calendar-header-inner\">      <button class=\"tui-calendar-btn tui-calendar-btn-prev-month\">Prev month</button>      <em class=\"tui-calendar-title {{titleClass}}\">{{title}}</em>      <button class=\"tui-calendar-btn tui-calendar-btn-next-month\">Next month</button>    </div>  {{/if}}{{else}}  <div class=\"tui-calendar-header-inner\">    <button class=\"tui-calendar-btn tui-calendar-btn-prev-year\">Prev year</button>    <em class=\"tui-calendar-title {{titleClass}}\">{{title}}</em>    <button class=\"tui-calendar-btn tui-calendar-btn-next-year\">Next year</button>  </div>{{/if}}{{if showToday}}  <div class=\"tui-calendar-header-info\">    <p class=\"tui-calendar-title-today\">{{todayText}}</p>  </div>{{/if}}", context);
				};
			}),
			(function(module$49, exports$49, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Check whether the given variable is a instance of HTMLNode or not.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$49.exports = isHTMLNode;
			}),
			(function(module$50, exports$50, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Send hostname on DOMContentLoaded.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$50.exports = sendHostname;
			}),
			(function(module$51, exports$51, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Request image ping.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$51.exports = imagePing;
			}),
			(function(module$52, exports$52, __webpack_require__) {
				"use strict";
				/**
				...
				module$52.exports = defineClass(
					/** @lends Body.prototype */
					{
						...
						_getLayer: function(type) {
							switch (type) {
								case TYPE_DATE: return this._dateLayer;
								case TYPE_MONTH: return this._monthLayer;
								case TYPE_YEAR: return this._yearLayer;
								default: return this._currentLayer;
							}
						},
			...
			(function(module$53, exports$53, __webpack_require__) {
				"use strict";
				/**
				...
				*/
					...
					/** @lends DateLayer.prototype */
					{
						...
						_makeContext: function(date) {
							...
							if (this.weekStartDay) {
								...
								for (i = 0; i < this.weekStartDay; i += 1) days.push(days.shift());
								daysShort = days;
							}
							return {
								Sun: daysShort[0],
						...
						_getWeeks: function(year, month) {
							...
							while (weekNumber < weeksCount) {
								dates = [];
								for (i = this.weekStartDay; i < DAYS_OF_WEEK + this.weekStartDay; i += 1) dates.push(dateUtil.getDateOfWeek(year, month, weekNumber, i));
						...
						_getWeek: function(currentYear, currentMonth, dates) {
							...
							for (; i < length; i += 1) {
								...
								date = dates[i];
								if (date < firstDateOfCurrentMonth) className += " tui-calendar-prev-month";
								if (date > lastDateOfCurrentMonth) className += " tui-calendar-next-month";
								if (date.getDay() === 0) className += " tui-calendar-sun";
								else if (date.getDay() === 6) className += " tui-calendar-sat";
								contexts.push({
						...
						render: function(date, container) {
							container.innerHTML = bodyTmpl(this._makeContext(date));
						...
						_getFirstWeek: function(year, month) {
							var firstWeekDates = [];
							var i;
							for (i = this.weekStartDay; i < DAYS_OF_WEEK + this.weekStartDay; i += 1) firstWeekDates.push(dateUtil.getDateOfWeek(year, month, -1, i));
				...
				module$53.exports = DateLayer;
			}),
			(function(module$54, exports$54, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(11);
				module$54.exports = function(context) {
					return template("<table class=\"tui-calendar-body-inner\" cellspacing=\"0\" cellpadding=\"0\">  <caption><span>Dates</span></caption>  <thead class=\"tui-calendar-body-header\">    <tr>      <th class=\"tui-sun\" scope=\"col\">{{Sun}}</th>      <th scope=\"col\">{{Mon}}</th>      <th scope=\"col\">{{Tue}}</th>      <th scope=\"col\">{{Wed}}</th>      <th scope=\"col\">{{Thu}}</th>      <th scope=\"col\">{{Fri}}</th>      <th class=\"tui-sat\" scope=\"col\">{{Sat}}</th>    </tr>  </thead>  <tbody>    {{each weeks}}    <tr class=\"tui-calendar-week\">      {{each @this}}      <td class=\"{{@this[\"className\"]}}\" data-timestamp=\"{{@this[\"timestamp\"]}}\">{{@this[\"dayInMonth\"]}}</td>      {{/each}}    </tr>    {{/each}}  </tbody></table>", context);
				};
			}),
			(function(module$55, exports$55, __webpack_require__) {
				"use strict";
				/**
			...
			(function(module$56, exports$56, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(11);
				module$56.exports = function(context) {
					return template("<table class=\"tui-calendar-body-inner\">  <caption><span>Months</span></caption>  <tbody>    <tr class=\"tui-calendar-month-group\">      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 0}}>{{Jan}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 1}}>{{Feb}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 2}}>{{Mar}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 3}}>{{Apr}}</td>    </tr>    <tr class=\"tui-calendar-month-group\">      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 4}}>{{May}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 5}}>{{Jun}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 6}}>{{Jul}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 7}}>{{Aug}}</td>    </tr>    <tr class=\"tui-calendar-month-group\">      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 8}}>{{Sep}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 9}}>{{Oct}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 10}}>{{Nov}}</td>      <td class=\"tui-calendar-month\" data-timestamp={{getFirstDayTimestamp year 11}}>{{Dec}}</td>    </tr>  </tbody></table>", context);
				};
			}),
			(function(module$57, exports$57, __webpack_require__) {
				"use strict";
				/**
			...
			(function(module$58, exports$58, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(11);
				module$58.exports = function(context) {
					return template("<table class=\"tui-calendar-body-inner\">  <caption><span>Years</span></caption>  <tbody>    {{each yearGroups}}    <tr class=\"tui-calendar-year-group\">      {{each @this}}      <td class=\"tui-calendar-year\" data-timestamp={{getFirstDayTimestamp @this 0}}>        {{@this}}      </td>      {{/each}}    </tr>    {{/each}}  </tbody></table>", context);
				};
			}),
			(function(module$59, exports$59, __webpack_require__) {
				"use strict";
				/**
				...
				module$59.exports = defineClass(
					/** @lends RangeModel.prototype */
					{
						...
						hasOverlap: function(start, end) {
							...
							for (; i < length; i += 1) {
								range = this._ranges[i];
								if (range.isOverlapped(start, end)) return true;
							}
							return false;
						},
						add: function(start, end) {
							...
							if (!overlapped) this._ranges.splice(i, 0, new Range(start, end));
						},
						...
						exclude: function(start, end) {
							...
							forEachArray(this._ranges, function(range) {
								...
								if (range.isOverlapped(start, end)) {
									...
									if (end + 1 <= rangeEnd) this.add(end + 1, rangeEnd);
								}
							}, this);
						...
						findOverlappedRange: function(start, end) {
							...
							for (; i < len; i += 1) {
								range = this._ranges[i];
								if (range.isOverlapped(start, end)) return [range.start, range.end];
							}
							return null;
						}
					}
			...
			(function(module$60, exports$60, __webpack_require__) {
				"use strict";
				/**
				...
				module$60.exports = defineClass(
					/** @lends Range.prototype */
					{
						...
						merge: function(start, end) {
							if (!isNumber(start) || !isNumber(end) || !this.isOverlapped(start, end)) return;
						...
						exclude: function(start, end) {
							if (start <= this.start && end >= this.end) this.setEmpty();
							else if (this.contains(start)) this.setRange(this.start, start - 1);
							else if (this.contains(end)) this.setRange(end + 1, this.end);
						}
					}
				);
			}),
			(function(module$61, exports$61, __webpack_require__) {
				"use strict";
				var template = __webpack_require__(11);
				module$61.exports = function(context) {
					return template("<div class=\"tui-datepicker\">  {{if timePicker}}    {{if isTab}}      <div class=\"tui-datepicker-selector\">        <button type=\"button\" class=\"tui-datepicker-selector-button tui-is-checked\" aria-label=\"selected\">          <span class=\"tui-ico-date\"></span>{{localeText[\"date\"]}}        </button>        <button type=\"button\" class=\"tui-datepicker-selector-button\">          <span class=\"tui-ico-time\"></span>{{localeText[\"time\"]}}        </button>      </div>      <div class=\"tui-datepicker-body\">        <div class=\"tui-calendar-container\"></div>        <div class=\"tui-timepicker-container\"></div>      </div>    {{else}}      <div class=\"tui-datepicker-body\">        <div class=\"tui-calendar-container\"></div>      </div>      <div class=\"tui-datepicker-footer\">        <div class=\"tui-timepicker-container\"></div>      </div>    {{/if}}  {{else}}    <div class=\"tui-datepicker-body\">      <div class=\"tui-calendar-container\"></div>    </div>  {{/if}}</div>", context);
				};
			}),
			(function(module$62, exports$62, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				var DatePickerInput = defineClass(
					/** @lends DatePickerInput.prototype */
					{
						...
						enable: function() {
							if (this._input) this._input.removeAttribute("disabled");
						},
						disable: function() {
							if (this._input) this._input.setAttribute("disabled", true);
						},
						getFormat: function() {
						...
						setDate: function(date) {
							if (this._input) this._input.value = this._formatter.format(date);
						},
						getDate: function() {
							var value = "";
				...
				module$62.exports = DatePickerInput;
			}),
			(function(module$63, exports$63, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				var DateRangePicker = defineClass(
					/** @lends DateRangePicker.prototype */
					{
						...
						_onDrawPicker: function(eventData) {
							...
							if (!startDate) return;
							if (!endDate) endDate = /* @__PURE__ */ new Date(NaN);
							forEachArray(eventData.dateElements, function(el) {
								var elDate = new Date(Number(getData(el, "timestamp")));
						...
						_setRangeClass: function(el, isInRange) {
							if (isInRange) addClass(el, CLASS_NAME_SELECTED_RANGE);
							else removeClass(el, CLASS_NAME_SELECTED_RANGE);
						},
						_setSelectedClass: function(el, isSelected) {
							if (isSelected) addClass(el, CLASS_NAME_SELECTED);
							else removeClass(el, CLASS_NAME_SELECTED);
						},
						...
						_onChangeEndpicker: function() {
							...
							*/
							...
							if (endPickerDate) {
								...
								if (this._preEndPickerDate !== date) this._setTimeRangeOnEndPicker();
								this._preEndPickerDate = date;
							} else this._preEndPickerDate = null;
				...
				module$63.exports = DateRangePicker;
			}),
			(function(module$64, exports$64, __webpack_require__) {})
		]);
	});
})))(), 1);
...
var __spreadValues = (a2, b2) => {
	...
	if (__getOwnPropSymbols) {
		for (var prop of __getOwnPropSymbols(b2)) if (__propIsEnum.call(b2, prop)) __defNormalProp(a2, prop, b2[prop]);
	}
	return a2;
};
...
function w$3(n2, l2, u2, i2, t2, o2, r2, c2, s2, a2) {
	...
	for (u2.__k = [], h2 = 0; h2 < l2.length; h2++) if ((k2 = u2.__k[h2] = (k2 = l2[h2]) == null || typeof k2 == "boolean" ? null : typeof k2 == "string" || typeof k2 == "number" || typeof k2 == "bigint" ? v$3(null, k2, null, null, k2) : Array.isArray(k2) ? v$3(p$3, { children: k2 }, null, null, null) : k2.__b > 0 ? v$3(k2.type, k2.props, k2.key, null, k2.__v) : k2) != null) {
		if (k2.__ = u2, k2.__b = u2.__b + 1, (d2 = x2[h2]) === null || d2 && k2.key == d2.key && k2.type === d2.type) x2[h2] = void 0;
		...
		j$3(n2, k2, d2 = d2 || f$3, t2, o2, r2, c2, s2, a2), b2 = k2.__e, (y2 = k2.ref) && d2.ref != y2 && (w2 || (w2 = []), d2.ref && w2.push(d2.ref, null, k2), w2.push(y2, k2.__c || b2, k2)), b2 != null ? (g2 ??= b2, typeof k2.type == "function" && k2.__k === d2.__k ? k2.__d = s2 = m$2(k2, s2, n2) : s2 = A$2(n2, k2, d2, x2, b2, s2), typeof u2.type == "function" && (u2.__d = s2)) : s2 && d2.__e == s2 && s2.parentNode != n2 && (s2 = _$3(d2));
	}
...
function H$2(n2, l2, u2, i2, t2) {
	...
	else if (l2[0] === "o" && l2[1] === "n") o2 = l2 !== (l2 = l2.replace(/Capture$/, "")), l2 = l2.toLowerCase() in n2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + o2] = u2, u2 ? i2 || n2.addEventListener(l2, o2 ? T$2 : I$2, o2) : n2.removeEventListener(l2, o2 ? T$2 : I$2, o2);
...
function j$3(n2, u2, i2, t2, o2, r2, f2, e2, c2) {
	...
	try {
		n: if (typeof H2 == "function") {
			if (g2 = u2.props, m2 = (a2 = H2.contextType) && t2[a2.__c], x2 = a2 ? m2 ? m2.props.value : a2.__ : t2, i2.__c ? b2 = (h2 = u2.__c = i2.__c).__ = h2.__E : ("prototype" in H2 && H2.prototype.render ? u2.__c = h2 = new H2(g2, x2) : (u2.__c = h2 = new d$3(g2, x2), h2.constructor = H2, h2.render = O$2), m2 && m2.sub(h2), h2.props = g2, h2.state || (h2.state = {}), h2.context = x2, h2.__n = t2, v2 = h2.__d = true, h2.__h = []), h2.__s ?? (h2.__s = h2.state), H2.getDerivedStateFromProps != null && (h2.__s == h2.state && (h2.__s = s$3({}, h2.__s)), s$3(h2.__s, H2.getDerivedStateFromProps(g2, h2.__s))), y2 = h2.props, _2 = h2.state, v2) H2.getDerivedStateFromProps == null && h2.componentWillMount != null && h2.componentWillMount(), h2.componentDidMount != null && h2.__h.push(h2.componentDidMount);
			else {
			...
			if (h2.context = x2, h2.props = g2, h2.__v = u2, h2.__P = n2, A2 = l$3.__r, C2 = 0, "prototype" in H2 && H2.prototype.render) h2.state = h2.__s, h2.__d = false, A2 && A2(u2), a2 = h2.render(h2.props, h2.state, h2.context);
			else do
...
function L$2(l2, u2, i2, t2, o2, r2, e2, c2) {
	...
	if (d2 === null) y2 === p2 || c2 && l2.data === p2 || (l2.data = p2);
	else {
		...
		if (C$1(l2, p2, y2, o2, c2), v2) u2.__k = [];
		else if (k2 = u2.props.children, w$3(l2, Array.isArray(k2) ? k2 : [k2], u2, i2, t2, o2 && d2 !== "foreignObject", r2, e2, r2 ? r2[0] : i2.__k && _$3(i2, 0), c2), r2 != null) for (k2 = r2.length; k2--;) r2[k2] != null && a$3(r2[k2]);
...
n$2 = e$1.slice, l$3 = { __e: function(n2, l2, u2, i2) {
	...
	var u2 = this.__s != null && this.__s !== this.state ? this.__s : this.__s = s$3({}, this.state);
	typeof n2 == "function" && (n2 = n2(s$3({}, u2), this.props)), n2 && s$3(u2, n2), n2 != null && this.__v && (l2 && this.__h.push(l2), b$2(this));
...
function q$2(n2) {
	...
	return o2.c = n2, r2 ? (o2.__ ?? (o2.__ = true, r2.sub(u$2)), r2.props.value) : n2.__;
}
function b$1() {
...
function F$1(n2, r2) {
	switch (r2) {
		case 2: return new Map(n2);
		case 3: return Array.from(n2);
	}
	return l$1(n2);
}
...
function range(start, stop, step) {
	...
	flag = step < 0 ? -1 : 1;
	stop *= flag;
	for (; start * flag < stop; start += step) arr.push(start);
	return arr;
}
var range_1 = range;
...
function cls(...args) {
	...
	args.forEach((arg) => {
		if (!arg) return;
		if (isString_1(arg)) result.push(arg);
		else Object.keys(arg).forEach((className2) => {
			if (arg[className2]) result.push(className2);
		});
	});
...
function extractPercentPx(value) {
	const percentResult = value.match(/(\d+)%/);
	const pxResult = value.match(/(-?)\s?(\d+)px/);
	return {
...
var LocalDate = class LocalDate {
	constructor(...args) {
		const [firstArg] = args;
		if (firstArg instanceof Date) this.d = new Date(firstArg.getTime());
		else if (isString_1(firstArg) && args.length === 1) this.d = createFromDateString(firstArg);
		if (!this.d) this.d = new Date(...args);
	}
	setTimezoneOffset() {
		throwNotSupported();
	}
...
var UTCDate = class UTCDate extends LocalDate {
	clone() {
...
function calculateTimezoneOffset(timezoneName, targetDate = new TZDate()) {
	...
	const utcDate = tokenToUtcDate(tokenizeTZDate(targetDate, timezoneName));
	return Math.round((utcDate.getTime() - targetDate.getTime()) / 60 / 1e3);
}
function isUsingDST(targetDate, timezoneName) {
	if (timezoneName) validateIANATimezoneName(timezoneName);
	const jan = new TZDate(targetDate.getFullYear(), 0, 1);
	const jul = new TZDate(targetDate.getFullYear(), 6, 1);
	if (timezoneName) return Math.max(-calculateTimezoneOffset(timezoneName, jan), -calculateTimezoneOffset(timezoneName, jul)) !== -calculateTimezoneOffset(timezoneName, targetDate);
...
function validateIANATimezoneName(timezoneName) {
	if (timezoneNameValidationCache[timezoneName]) return true;
	try {
...
function getDateTimeFormat(timezoneName) {
	if (dtfCache[timezoneName]) return dtfCache[timezoneName];
...
function tokenizeTZDate(tzDate, timezoneName) {
	return getDateTimeFormat(timezoneName).formatToParts(tzDate.toDate()).reduce((result, cur) => {
		const pos = typeToPos[cur.type];
		if (isPresent(pos)) result[pos] = parseInt(cur.value, 10);
		return result;
	}, []);
}
...
var TZDate = class TZDate {
	constructor(...args) {
		this.tzOffset = null;
		if (args[0] instanceof TZDate) this.d = date(args[0].getTime());
		else this.d = date(...args);
	}
	toString() {
		return this.d.toString();
	}
	...
	tz(tzValue) {
		if (tzValue === "Local") return new TZDate(this.getTime());
...
function mergeObject(target, source = {}) {
	if (!isObject_1(source)) return target;
	Object.keys(source).forEach((k2) => {
		const targetKey = k2;
		const sourceKey = k2;
		if (!Array.isArray(source[sourceKey]) && isObject_1(target[targetKey]) && isObject_1(source[sourceKey]) && !(source[sourceKey] instanceof TZDate)) target[targetKey] = mergeObject(target[targetKey], source[sourceKey]);
...
var EventUIModel = class EventUIModel {
	constructor(event) {
		this.top = 0;
		this.left = 0;
		this.width = 0;
	...
	getStarts() {
		if (this.renderStarts) return this.renderStarts;
		return this.model.getStarts();
	}
	getEnds() {
		if (this.renderEnds) return this.renderEnds;
	...
	collidesWith(uiModel, usingTravelTime = true) {
		...
		[this, uiModel].forEach((event) => {
			if (event instanceof EventUIModel && event.duplicateEvents.length > 0) infos.push({
	...
	clone() {
		...
		if (this.renderStarts) clonedEventUIModel.renderStarts = new TZDate(this.renderStarts);
		if (this.renderEnds) clonedEventUIModel.renderEnds = new TZDate(this.renderEnds);
...
function bsearch(arr, search, fn2, compareFn) {
	...
	while (minIndex <= maxIndex) {
		...
		if (comp < 0) minIndex = currentIndex + 1;
		else if (comp > 0) maxIndex = currentIndex - 1;
...
var array = {
	bsearch,
	compare: {
		event: { asc: compareEventsASC },
		num: { asc: compareNumbersASC }
	}
};
...
function findLastIndex(array2, predicate) {
	for (let i2 = array2.length - 1; i2 >= 0; i2 -= 1) if (predicate(array2[i2])) return i2;
	return -1;
}
function fill(length, value) {
	if (length > 0) return Array.from({ length }, () => {
...
var MS_PER_THIRTY_MINUTES = 1800 * 1e3;
...
function convMilliseconds(type, value, iteratee) {
	...
	if (!(type in index) || isNaN(value)) return 0;
...
function parse(str, fixMonth = -1) {
	...
	let ymd;
	let hms;
	if (!matches) throw new InvalidDateTimeFormatError(str);
	if (str.length > 8) {
		separator = ~str.indexOf("/") ? "/" : "-";
		const result = matches.splice(1);
		ymd = result[0].split(separator);
		hms = result[1] ? result[1].split(":") : [
			0,
			0,
			0
		];
...
function getRowStyleInfo(days, narrowWeekend, startDayOfWeek, workweek) {
	...
	const rowStyleInfo = dates.map((day) => {
		...
		if (days > limitDaysToApplyNarrowWeekend && narrowWeekend && isWeekend(day)) width = wideWidth / 2;
		const model = {
			width,
	...
	rowStyleInfo.forEach(({ width }, index) => {
		for (let i2 = 0; i2 <= index; i2 += 1) for (let j2 = index; j2 < length; j2 += 1) cellWidthMap[i2][j2] += width;
	});
...
function collidesWith({ start, end, targetStart, targetEnd, goingDuration, comingDuration, targetGoingDuration, targetComingDuration, usingTravelTime }) {
	if (Math.abs(end - start) < MS_EVENT_MIN_DURATION) end += MS_EVENT_MIN_DURATION;
	if (Math.abs(end - start) < MS_EVENT_MIN_DURATION) end += MS_EVENT_MIN_DURATION;
	if (usingTravelTime) {
...
function stamp(obj) {
	if (!obj.__fe_id) obj.__fe_id = getId();
	return obj.__fe_id;
}
var EventModel = class {
	...
	init({ id = "", calendarId = "", title = "", body = "", isAllday: isAllday2 = false, start = new TZDate(), end = new TZDate(), goingDuration = 0, comingDuration = 0, location: location2 = "", attendees = [], category = "time", dueDateClass = "", recurrenceRule = "", state = "Busy", isVisible = true, isPending = false, isFocused = false, isReadOnly = false, isPrivate = false, color, backgroundColor, dragBackgroundColor, borderColor, customStyle = {}, raw = null } = {}) {
		this.id = id;
		...
		this.raw = raw;
		if (this.isAllday) this.setAlldayPeriod(start, end);
		else this.setTimePeriod(start, end);
		if (category === "milestone" || category === "task") this.start = new TZDate(this.end);
	}
	setAlldayPeriod(start, end) {
		let startedAt;
		let endedAt;
		if (isString_1(start)) startedAt = parse(start.substring(0, 10));
		else startedAt = new TZDate(start || Date.now());
		if (isString_1(end)) endedAt = parse(end.substring(0, 10));
		else endedAt = new TZDate(end || this.start);
	...
	setTimePeriod(start, end) {
		...
		if (!end) this.end.setMinutes(this.end.getMinutes() + 30);
	...
	equals(event) {
		...
		if (this.title !== event.title) return false;
		if (this.body !== event.body) return false;
		if (this.isAllday !== event.isAllday) return false;
		if (compare(this.getStarts(), event.getStarts()) !== 0) return false;
		if (compare(this.getEnds(), event.getEnds()) !== 0) return false;
		if (this.color !== event.color) return false;
		if (this.backgroundColor !== event.backgroundColor) return false;
		if (this.dragBackgroundColor !== event.dragBackgroundColor) return false;
		if (this.borderColor !== event.borderColor) return false;
		return true;
	}
	duration() {
		...
		let duration;
		if (this.isAllday) duration = Number(toEndOfDay(end)) - Number(toStartOfDay(start));
...
var Collection = class Collection {
	constructor(getItemIDFn) {
		...
		if (isFunction$2(getItemIDFn)) this.getItemID = getItemIDFn;
	}
	static and(...filterFns) {
		const { length } = filterFns;
		return (item) => {
			for (let i2 = 0; i2 < length; i2 += 1) if (!filterFns[i2].call(null, item)) return false;
			return true;
		};
	}
	static or(...filterFns) {
		...
		return (item) => {
			...
			for (let i2 = 1; i2 < length; i2 += 1) result = result || filterFns[i2].call(null, item);
			return result;
		};
	}
	getItemID(item) {
	...
	remove(...items) {
		...
		items.forEach((item) => {
			...
			if (!this.internalMap.has(id)) return;
	...
	filter(filterFn) {
		...
		if (this.hasOwnProperty("getItemID")) result.getItemID = this.getItemID;
		this.internalMap.forEach((item) => {
			if (filterFn(item) === true) result.add(item);
		});
		return result;
	}
	groupBy(groupByFn) {
		...
		this.internalMap.forEach((item) => {
			...
			if (isFunction$2(key)) key = key.call(item);
			result[key] ?? (result[key] = new Collection(this.getItemID));
			result[key].add(item);
		});
		return result;
	}
	...
	each(iteratee) {
		...
		while (next.done === false) {
			...
			if (iteratee(value, key) === false) break;
			next = entries.next();
		}
	}
	clear() {
...
function createEventCollection(...initItems) {
	...
	if (initItems.length) collection.add(...initItems);
	return collection;
}
...
function filterByCategory(uiModel) {
	const { model } = uiModel;
	if (isAllday(model)) return "allday";
	return model.category;
}
function addToMatrix(idsOfDay, event) {
	getDateRange(event.getStarts(), event.getEnds()).forEach((date2) => {
		const ymd = toFormat(date2, "YYYYMMDD");
		(idsOfDay[ymd] = idsOfDay[ymd] || []).push(event.cid());
	});
}
...
function createEvent(calendarData, eventData) {
	return addEvent(calendarData, new EventModel(eventData));
}
	...
	return {
		...
		setCalendarColor: (calendarId, colorOptions) => set(produce((state) => {
			const calendars = state.calendar.calendars.map((calendar) => {
				if (calendar.id === calendarId) return __spreadValues(__spreadValues({}, calendar), colorOptions);
				return calendar;
			});
			const collection = createEventCollection(...state.calendar.events.toArray().map((event) => {
				var _a, _b, _c, _d;
		...
		setCalendarVisibility: (calendarIds, isVisible) => set(produce((state) => {
			...
			state.calendar.events = createEventCollection(...events.map((event) => {
				if (calendarIds.includes(event.calendarId)) event.isVisible = isVisible;
				return event;
			}));
		}))
	};
...
function createDndDispatchers(set) {
	return {
		initDrag: (initState) => {
			set(produce((state) => {
				state.dnd = __spreadProps(__spreadValues(__spreadValues({}, state.dnd), initState), { draggingState: 1 });
			}));
		},
		setDragging: (newState) => {
			set(produce((state) => {
				state.dnd = __spreadProps(__spreadValues(__spreadValues({}, state.dnd), newState), { draggingState: 2 });
			}));
		},
		cancelDrag: () => {
			set(produce((state) => {
...
function getRestPanelHeight(dayGridRowsState, lastPanelType, initHeight) {
	return Object.keys(dayGridRowsState).reduce((acc, rowName) => {
		if (rowName === lastPanelType) return acc;
	...
	return {
		setLastPanelType: (type) => {
			set(produce((state) => {
				...
				if (type) state.weekViewLayout.dayGridRows[type].height = getRestPanelHeight(state.weekViewLayout.dayGridRows, type, state.layout);
			}));
		},
		updateLayoutHeight: (height) => set(produce((state) => {
			const { lastPanelType } = state.weekViewLayout;
			state.layout = height;
			if (lastPanelType) state.weekViewLayout.dayGridRows[lastPanelType].height = getRestPanelHeight(state.weekViewLayout.dayGridRows, lastPanelType, height);
		})),
		updateDayGridRowHeight: ({ rowName, height }) => set(produce((state) => {
			const { lastPanelType } = state.weekViewLayout;
			state.weekViewLayout.dayGridRows[rowName] = { height };
			if (lastPanelType) state.weekViewLayout.dayGridRows[lastPanelType].height = getRestPanelHeight(state.weekViewLayout.dayGridRows, lastPanelType, state.layout);
		})),
...
function initializeCollapseDuplicateEvents(options) {
	...
	if (isBoolean_1(options)) return initialCollapseDuplicateEvents;
...
function initializeTimezoneOptions(timezoneOptions = {}) {
	return __spreadValues({ zones: [] }, timezoneOptions);
}
function initializeMonthOptions(monthOptions = {}) {
	...
	if (month.dayNames.length === 0) month.dayNames = DEFAULT_DAY_NAMES.slice();
	return month;
}
function initializeGridSelectionOptions(options) {
	if (isBoolean_1(options)) return {
...
function createOptionsDispatchers(set) {
	return { setOptions: (newOptions = {}) => set(produce((state) => {
		var _a;
		if (newOptions.gridSelection) newOptions.gridSelection = initializeGridSelectionOptions(newOptions.gridSelection);
		if ((_a = newOptions.week) == null ? void 0 : _a.collapseDuplicateEvents) newOptions.week.collapseDuplicateEvents = initializeCollapseDuplicateEvents(newOptions.week.collapseDuplicateEvents);
...
function createPopupDispatchers(set) {
	return {
		...
		showDetailPopup: (param, isOpenedInSeeMorePopup) => set(produce((state) => {
			...
			state.popup["form"] = null;
			if (!isOpenedInSeeMorePopup) state.popup["seeMore"] = null;
		})),
...
function invalidateSizeValue(value) {
	if (isString_1(value)) return CSS_AUTO_REGEX.test(value);
	return value === null;
}
function getSize(el) {
...
var elProto = (typeof Element === "undefined" ? noop : Element).prototype;
elProto.matches || elProto.webkitMatchesSelector || elProto.msMatchesSelector;
...
var templates = {
	milestone(model) {
		return /* @__PURE__ */ h$3(p$3, null, /* @__PURE__ */ h$3("span", { className: cls("icon", "ic-milestone") }), /* @__PURE__ */ h$3("span", { style: { backgroundColor: model.backgroundColor } }, stripTags(model.title)));
	},
	milestoneTitle() {
		return /* @__PURE__ */ h$3("span", { className: cls("left-content") }, "Milestone");
	},
	task(model) {
		return `#${model.title}`;
	},
	taskTitle() {
		return /* @__PURE__ */ h$3("span", { className: cls("left-content") }, "Task");
	},
	alldayTitle() {
		return /* @__PURE__ */ h$3("span", { className: cls("left-content") }, "All Day");
	},
	allday(model) {
	...
	time(model) {
		...
		if (start) return /* @__PURE__ */ h$3("span", null, /* @__PURE__ */ h$3("strong", null, toFormat(start, "HH:mm")), "\xA0", /* @__PURE__ */ h$3("span", null, stripTags(title)));
	...
	monthMoreTitleDate(moreTitle) {
		...
		return /* @__PURE__ */ h$3(p$3, null, /* @__PURE__ */ h$3("span", { className: classNameDay }, date2), /* @__PURE__ */ h$3("span", { className: classNameDayLabel }, dayName));
	},
	monthMoreClose() {
		return "";
	},
	monthGridHeader(model) {
		...
		return /* @__PURE__ */ h$3("span", { className: cls("weekday-grid-date", { "weekday-grid-date-decorator": model.isToday }) }, date2);
	},
	monthGridHeaderExceed(hiddenEvents) {
		return /* @__PURE__ */ h$3("span", { className: cls("weekday-grid-more-events") }, hiddenEvents, " more");
	},
	...
	weekDayName(model) {
		...
		return /* @__PURE__ */ h$3(p$3, null, /* @__PURE__ */ h$3("span", { className: classDate }, model.date), "\xA0\xA0", /* @__PURE__ */ h$3("span", { className: className2 }, model.dayName));
	},
	weekGridFooterExceed(hiddenEvents) {
		return `+${hiddenEvents}`;
	},
	collapseBtnTitle() {
		return /* @__PURE__ */ h$3("span", { className: cls("collapse-btn-icon") });
	},
	...
	popupDetailDate({ isAllday: isAllday2, start, end }) {
		...
		if (isAllday2) return `${startDate}${isSameDate(start, end) ? "" : ` - ${toFormat(end, dayFormat)}`}`;
...
function createTemplateSlice(templateConfig = {}) {
	return { template: __spreadValues(__spreadValues({}, templates), templateConfig) };
}
function createTemplateDispatchers(set) {
	return { setTemplate: (template) => set(produce((state) => {
...
var useIsomorphicLayoutEffect = isUndefined_1(window) || !window.navigator ? _$2 : h$2;
function createStoreContext() {
	const StoreContext = B$1(null);
	function StoreProvider2({ children, store }) {
	...
	const useStore2 = (selector, equalityFn = Object.is) => {
		...
		if (isNil(storeCtx)) throw new Error("StoreProvider is not found");
		...
		if (isUndefined_1(currentSliceRef.current)) currentSliceRef.current = selector(state);
		let newStateSlice;
		let hasNewStateSlice = false;
		if (stateRef.current !== state || selectorRef.current !== selector || equalityFnRef.current !== equalityFn || hasErrorRef.current) {
		...
		useIsomorphicLayoutEffect(() => {
			...
			if (storeCtx.getState() !== stateBeforeSubscriptionRef.current) listener();
			return unsubscribe;
		}, []);
...
function useDispatch(group) {
	return useStore(T$1((state) => {
		if (!group) return state.dispatch;
...
(function(module, exports) {
	(function(global2, factory) {
		...
		if (!apply) apply = function apply2(fun, thisValue, args) {
		...
		if (!construct) construct = function construct2(Func, args) {
		...
		var _createTrustedTypesPolicy = function _createTrustedTypesPolicy2(trustedTypes, document2) {
			...
			if (document2.currentScript && document2.currentScript.hasAttribute(ATTR_NAME)) suffix = document2.currentScript.getAttribute(ATTR_NAME);
			var policyName = "dompurify" + (suffix ? "#" + suffix : "");
			try {
				return trustedTypes.createPolicy(policyName, { createHTML: function createHTML(html2) {
					return html2;
				} });
			} catch (_2) {
		...
		function createDOMPurify() {
			...
			var _parseConfig = function _parseConfig2(cfg) {
				...
				if (cfg.ADD_TAGS) {
					if (ALLOWED_TAGS === DEFAULT_ALLOWED_TAGS) ALLOWED_TAGS = clone2(ALLOWED_TAGS);
					addToSet(ALLOWED_TAGS, cfg.ADD_TAGS);
				}
				if (cfg.ADD_ATTR) {
					if (ALLOWED_ATTR === DEFAULT_ALLOWED_ATTR) ALLOWED_ATTR = clone2(ALLOWED_ATTR);
			...
			var _sanitizeElements = function _sanitizeElements2(currentNode) {
				...
				if (!ALLOWED_TAGS[tagName] || FORBID_TAGS[tagName]) {
					...
					if (KEEP_CONTENT && !FORBID_CONTENTS[tagName]) {
						...
						if (childNodes && parentNode) for (var i2 = childNodes.length - 1; i2 >= 0; --i2) parentNode.insertBefore(cloneNode(childNodes[i2], true), getNextSibling(currentNode));
					}
					_forceRemove(currentNode);
					return true;
				}
			...
			var _sanitizeAttributes = function _sanitizeAttributes2(currentNode) {
				...
				while (l2--) {
					...
					if (!_isValidAttribute(transformCaseFunc(currentNode.nodeName), lcName, value)) continue;
					try {
			...
			DOMPurify.sanitize = function(dirty, cfg) {
				...
				if (!DOMPurify.isSupported) {
					if (_typeof(window2.toStaticHTML) === "object" || typeof window2.toStaticHTML === "function") {
						if (typeof dirty === "string") return window2.toStaticHTML(dirty);
						if (_isNode(dirty)) return window2.toStaticHTML(dirty.outerHTML);
					}
					return dirty;
				}
...
function addAttributeHooks() {
	browser.addHook("beforeSanitizeAttributes", (node) => {
		if (node.tagName === "A") {
			...
			if (targetValue) node.setAttribute(TEMP_TARGET_ATTRIBUTE, targetValue);
...
function Template({ template, param, as: tagName = "div" }) {
	var _a;
	const templateFunc = useStore(templateSelector)[template];
	if (isNil(templateFunc)) return null;
	const htmlOrVnode = templateFunc(param);
	return isString_1(htmlOrVnode) ? h$3(tagName, {
		className: cls(`template-${template}`),
		dangerouslySetInnerHTML: { __html: sanitize(htmlOrVnode) }
	}) : q$3(htmlOrVnode, { className: `${(_a = htmlOrVnode.props.className) != null ? _a : ""} ${cls(`template-${template}`)}` });
}
var EventBusContext = B$1(null);
var EventBusProvider = EventBusContext.Provider;
var useEventBus = () => {
	const eventBus = q$2(EventBusContext);
	if (!eventBus) throw new Error("useEventBus must be used within a EventBusProvider");
	return eventBus;
};
...
function usePrimaryTimezone() {
	...
	return [primaryTimezoneName, T$1(() => tzConverter(primaryTimezoneName), [primaryTimezoneName, tzConverter])];
}
function isWeekDayName(type, dayName) {
	return type === "week";
}
function getWeekDayNameColor({ dayName, theme, today }) {
	var _a, _b;
	const { day, dateInstance } = dayName;
	const isToday = isSameDate(today, dateInstance);
	const isPastDay = !isToday && dateInstance < today;
	if (isSunday(day)) return theme.common.holiday.color;
	if (isPastDay) return (_a = theme.week) == null ? void 0 : _a.pastDay.color;
	if (isSaturday(day)) return theme.common.saturday.color;
	if (isToday) return (_b = theme.week) == null ? void 0 : _b.today.color;
	return theme.common.dayName.color;
}
function getMonthDayNameColor({ dayName, theme }) {
	const { day } = dayName;
	if (isSunday(day)) return theme.common.holiday.color;
	if (isSaturday(day)) return theme.common.saturday.color;
	return theme.common.dayName.color;
...
function DayName({ dayName, style, type, theme }) {
	...
	const handleClick = () => {
		if (isWeekDayName(type)) eventBus.fire("clickDayName", { date: toFormat(dayName.dateInstance, "YYYY-MM-DD") });
	};
...
function createCommonTheme(commonTheme = {}) {
	return { common: mergeObject(DEFAULT_COMMON_THEME, commonTheme) };
}
...
function createMonthTheme(monthTheme = {}) {
	return { month: mergeObject(DEFAULT_MONTH_THEME, monthTheme) };
}
function createWeekTheme(weekTheme = {}) {
	return { week: mergeObject(DEFAULT_WEEK_THEME, weekTheme) };
}
var themeStoreCreator = (themeOptions = {}) => (set) => {
	return __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, createCommonTheme(themeOptions == null ? void 0 : themeOptions.common)), createWeekTheme(themeOptions == null ? void 0 : themeOptions.week)), createMonthTheme(themeOptions == null ? void 0 : themeOptions.month)), { dispatch: __spreadValues({}, createThemeDispatch(set)) });
};
var initThemeStore = (themeOptions = {}) => createStore(themeStoreCreator(themeOptions));
var { StoreProvider: ThemeProvider, useInternalStore: useInternalThemeStore, useStore: useTheme } = createStoreContext();
...
function monthDayNameSelector(theme) {
	return {
		...
		month: { dayName: theme.month.dayName }
	};
}
function GridHeader({ dayNames, marginLeft = DEFAULT_DAY_NAME_MARGIN_LEFT, rowStyleInfo, type = "month" }) {
	var _a, _b;
	const theme = useTheme(type === "month" ? monthDayNameSelector : weekDayNameSelector);
	const _c = (_b = (_a = theme[type]) == null ? void 0 : _a.dayName) != null ? _b : {}, { backgroundColor = "white", borderLeft = null } = _c;
	const { borderTop = null, borderBottom = null } = __objRest(_c, ["backgroundColor", "borderLeft"]);
	return /* @__PURE__ */ h$3("div", {
...
function getCollisionGroup(events, usingTravelTime = true) {
	...
	if (!events.length) return collisionGroups;
	...
	events.slice(1).forEach((event, index) => {
		...
		if (!found) collisionGroups.push([event.cid()]);
		else collisionGroups.slice().reverse().some((group) => {
...
function getLastRowInColumn(matrix, col) {
	...
	while (row > 0) {
		row -= 1;
		if (!isUndefined_1(matrix[row][col])) return row;
	}
	return -1;
}
		...
		group.forEach((eventID) => {
			...
			while (!found) {
				...
				if (lastRowInColumn === -1) {
					...
					if (isUndefined_1(matrix[nextRow])) matrix[nextRow] = [];
...
function _adjustRenderRange(start, end, uiModelColl) {
	uiModelColl.each((uiModel) => {
		if (uiModel.model.isAllday || uiModel.model.hasMultiDates) limitRenderRange(toStartOfDay(start), toEndOfDay(end), uiModel);
	});
}
function _getAlldayMaxTopIndexAtYMD(idsOfDay, ymd, uiModelAlldayColl) {
	...
	if (topIndexesInDate.length > 0) return Math.max(...topIndexesInDate);
	return 0;
}
function _adjustTimeTopIndex(idsOfDay, uiModelColl) {
	...
	sortedTimeEvents.forEach((timeUIModel) => {
		...
		if (isUndefined_1(alldayMaxTopInYMD)) alldayMaxTopInYMD = maxIndexInYMD[eventYMD] = _getAlldayMaxTopIndexAtYMD(idsOfDay, eventYMD, vAlldayColl);
	...
	sortedTimeEvents.forEach((timeUIModel) => {
		...
		if (topArrayInYMD.indexOf(timeUIModel.top) >= 0) {
			...
			for (let i2 = 1; i2 <= maxTopInYMD; i2 += 1) {
				timeUIModel.top = i2;
				if (topArrayInYMD.indexOf(timeUIModel.top) < 0) break;
			}
		}
...
function findByDateRange$1(calendarData, condition) {
	...
	const matrices = getMatrices(uiModelColl, getCollisionGroup(vList, usingTravelTime), usingTravelTime);
	positionUIModels(start, end, matrices, _weightTopValue);
	if (alldayFirstMode) _adjustTimeTopIndex(idsOfDay, uiModelColl);
	else _stackTimeFromTop(idsOfDay, uiModelColl);
	return matrices;
}
...
function _makeGetUIModelFuncForTimeView(hourStart, hourEnd) {
	if (hourStart === 0 && hourEnd === 24) return (uiModelColl) => {
...
function getUIModelForTimeView(idsOfDay, condition) {
	...
	Object.entries(ymdSplitted).forEach(([ymd, uiModelColl]) => {
		result[ymd] = getMatrices(uiModelColl, getCollisionGroup(_getUIModel(uiModelColl), usingTravelTime), usingTravelTime);
	});
	return result;
}
...
function getUIModelForAlldayView(start, end, uiModelColl) {
	if (!uiModelColl || !uiModelColl.size) return [];
	...
	const usingTravelTime = true;
	const matrices = getMatrices(uiModelColl, getCollisionGroup(uiModels, usingTravelTime), usingTravelTime);
...
function findByDateRange(calendarData, condition) {
	...
	const filterFn = Collection.and(...[getEventInDateRangeFilter(start, end)].concat(andFilters));
	const group = convertToUIModel(events.filter(filterFn)).groupBy(filterByCategory);
	return panels.reduce((acc, cur) => {
		const { name, type } = cur;
		if (isNil(group[name])) return acc;
		return __spreadProps(__spreadValues({}, acc), { [name]: type === "daygrid" ? getUIModelForAlldayView(start, end, group[name]) : getUIModelForTimeView(idsOfDay, {
			start,
			end,
...
function getGridWidthAndLeftPercentValues(row, narrowWeekend, totalWidth) {
	...
	const widthList = row.map((cell) => {
		...
		if (!narrowWeekend || isAllWeekend) return widthPerDay;
		return isWeekend(day) ? widthPerDay : widthPerDay * 2;
	});
	return {
		widthList,
		leftList: widthList.reduce((acc, _2, index) => index ? [...acc, acc[index - 1] + widthList[index - 1]] : [0], [])
	};
}
function getWidth(widthList, start, end) {
	return widthList.reduce((acc, width, index) => {
		if (start <= index && index <= end) return acc + width;
		return acc;
	}, 0);
}
...
var getEventLeftAndWidth = (start, end, row, narrowWeekend) => {
	...
	row.forEach((cell, index) => {
		if (cell <= start) gridStartIndex = index;
		if (cell <= end) gridEndIndex = index;
	});
	return {
...
function getEventUIModelWithPosition(uiModel, row, narrowWeekend = false) {
	const { width, left } = getEventLeftAndWidth(uiModel.getStarts(), uiModel.getEnds(), row, narrowWeekend);
	uiModel.width = width;
	uiModel.left = left;
	return uiModel;
}
function getRenderedEventUIModels(row, calendarData, narrowWeekend) {
	...
	const gridDateEventModelMap = Object.keys(idsOfDay).reduce((acc, ymd) => {
		acc[ymd] = idsOfDay[ymd].map((cid) => idEventModelMap[cid]).filter((vm) => !!vm);
		return acc;
	}, {});
	return {
...
var getWeekViewEvents = (row, calendarData, { narrowWeekend, hourStart, hourEnd, weekStartDate, weekEndDate }) => {
	...
	return Object.keys(eventModels).reduce((acc, cur) => {
		...
		return __spreadProps(__spreadValues({}, acc), { [cur]: Array.isArray(events) ? getDayGridEventModels(events, row, narrowWeekend) : getTimeGridEventModels(events) });
	}, {
		milestone: [],
		allday: [],
		task: [],
...
function createDateMatrixOfMonth(renderTargetDate, { workweek = false, visibleWeeksCount = 0, startDayOfWeek = 0, isAlways6Weeks = true }) {
	...
	if (shouldApplyVisibleWeeksCount) totalWeeksOfMatrix = visibleWeeksCount;
	else if (isAlways6Weeks === false) totalWeeksOfMatrix = Math.ceil(totalDatesOfMatrix / WEEK_DAYS);
...
function getWeekDates(renderDate, { startDayOfWeek = Day$2.SUN, workweek }) {
	...
	const prevDateCount = now.getDay() - startDayOfWeek;
	return (prevDateCount >= 0 ? range_1(-prevDateCount, WEEK_DAYS - prevDateCount) : range_1(-WEEK_DAYS - prevDateCount, -prevDateCount)).reduce((acc, day) => {
		const date2 = addDate(now, day);
		if (workweek && isWeekend(date2.getDay())) return acc;
		acc.push(date2);
		return acc;
	}, []);
}
function getColumnsData(datesOfWeek, narrowWeekend = false) {
	...
	return datesOfWeek.map((date2) => {
		return {
			date: date2,
			width: shouldApplyNarrowWeekend && isWeekend(date2.getDay()) ? defaultWidthByColumns / 2 : defaultWidthByColumns
		};
	}).reduce((result, currentDateAndWidth, index) => {
		const prev = result[index - 1];
		result.push(__spreadProps(__spreadValues({}, currentDateAndWidth), { left: index === 0 ? 0 : prev.left + prev.width }));
		return result;
	}, []);
}
function createTimeGridData(datesOfWeek, options) {
	...
	return {
		columns,
		rows: range_1(steps).map((step, index) => {
...
function getIndexFromPosition(arrayLength, maxRange, currentPosition) {
	return limit(Math.floor(ratio(maxRange, arrayLength, currentPosition)), [0], [arrayLength - 1]);
}
function createGridPositionFinder({ rowsCount, columnsCount, container, narrowWeekend = false, startDayOfWeek = Day$2.SUN }) {
	...
	return function gridPositionFinder(mousePosition) {
		...
		columnWidthList.forEach((width, index) => {
			if (index === 0) columnLeftList.push(0);
			else columnLeftList.push(columnLeftList[index - 1] + columnWidthList[index - 1]);
		});
		return {
			columnIndex: findLastIndex(columnLeftList, (columnLeft) => left >= columnLeft),
...
function calculateTimeGridSelectionByCurrentIndex(timeGridSelection, columnIndex, maxRowIndex) {
	if (isNil(timeGridSelection)) return null;
	const { startColumnIndex, endColumnIndex, endRowIndex, startRowIndex } = timeGridSelection;
	if (!isBetween$1(columnIndex, startColumnIndex, endColumnIndex)) return null;
	const resultGridSelection = {
		startRowIndex,
		endRowIndex,
		isSelectingMultipleColumns: startColumnIndex !== endColumnIndex,
		isStartingColumn: columnIndex === startColumnIndex
	};
	if (startColumnIndex < columnIndex && columnIndex < endColumnIndex) {
		...
		if (startColumnIndex === columnIndex) resultGridSelection.endRowIndex = maxRowIndex;
		else if (endColumnIndex === columnIndex) resultGridSelection.startRowIndex = 0;
	}
	return resultGridSelection;
}
var timeGridSelectionHelper = {
	sortSelection: (initPos, currentPos) => {
		return createSortedGridSelection(initPos, currentPos, initPos.columnIndex > currentPos.columnIndex || initPos.columnIndex === currentPos.columnIndex && initPos.rowIndex > currentPos.rowIndex);
	},
	getDateFromCollection: (dateCollection, gridSelection) => {
		const timeGridData = dateCollection;
		return [setTimeStrToDate(timeGridData.columns[gridSelection.startColumnIndex].date, timeGridData.rows[gridSelection.startRowIndex].startTime), setTimeStrToDate(timeGridData.columns[gridSelection.endColumnIndex].date, timeGridData.rows[gridSelection.endRowIndex].endTime)];
	},
...
function calculateDayGridMonthSelectionByCurrentIndex(gridSelection, currentIndex, weekLength) {
	if (!(isPresent(gridSelection) && isPresent(currentIndex) && isPresent(weekLength))) return null;
	const { startRowIndex, startColumnIndex, endRowIndex, endColumnIndex } = gridSelection;
	if (!isBetween$1(currentIndex, Math.min(startRowIndex, endRowIndex), Math.max(startRowIndex, endRowIndex))) return null;
	let startCellIndex = startColumnIndex;
	let endCellIndex = endColumnIndex;
	if (startRowIndex < currentIndex) startCellIndex = 0;
	if (endRowIndex > currentIndex) endCellIndex = weekLength - 1;
	return {
		startCellIndex,
		endCellIndex
	};
...
var dayGridMonthSelectionHelper = {
	sortSelection: (initPos, currentPos) => {
		return createSortedGridSelection(initPos, currentPos, initPos.rowIndex > currentPos.rowIndex || initPos.rowIndex === currentPos.rowIndex && initPos.columnIndex > currentPos.columnIndex);
	},
	getDateFromCollection: (dateCollection, gridSelection) => {
...
var alldayGridRowSelectionHelper = {
	sortSelection: (initPos, currentPos) => {
		return createSortedGridSelection(initPos, currentPos, initPos.columnIndex > currentPos.columnIndex);
	},
	getDateFromCollection: (dateCollection, gridSelection) => {
...
function AlldayGridSelection({ weekDates, narrowWeekend }) {
	...
	if (isNil(calculatedGridSelection)) return null;
...
l$3.__e = function(n2, t2, e2, r2) {
	if (n2.then) {
		for (var u2, o2 = t2; o2 = o2.__;) if ((u2 = o2.__c) && u2.__c) return t2.__e ?? (t2.__e = e2.__e, t2.__k = e2.__k), u2.__c(n2, t2);
	}
	A(n2, t2, e2, r2);
};
var O = l$3.unmount;
...
d$3.prototype.isReactComponent = {}, [
	"componentWillMount",
...
function CollapseButton({ isClicked, isClickedIndex, onClickCollapseButton }) {
	...
	}, /* @__PURE__ */ h$3(Template, { template: "collapseBtnTitle" })) : null;
}
function GridCell$1({ width, left, index, exceedCount, isClicked, onClickExceedCount, isClickedIndex, onClickCollapseButton, isLastCell }) {
...
var GridCells = g$1(function GridCells2({ uiModels, weekDates, narrowWeekend, height, clickedIndex, isClickedCount, onClickExceedCount, onClickCollapseButton }) {
	...
	return /* @__PURE__ */ h$3(p$3, null, weekDates.map((cell, index) => {
		...
		const exceedCount = getExceedCount(uiModels.filter(isInGrid(cell)), height, EVENT_HEIGHT + eventTopMargin);
...
function HorizontalEventResizeIcon({ onMouseDown }) {
	...
	}, /* @__PURE__ */ h$3("i", { className: `${cls("icon")} ${cls("ic-handle-y")}` }));
}
var LayoutContainerContext = B$1(null);
var LayoutContainerProvider = LayoutContainerContext.Provider;
var useLayoutContainer = () => {
	const ref = q$2(LayoutContainerContext);
	if (isUndefined_1(ref)) throw new Error("LayoutContainerProvider is not found");
	return ref;
};
var DRAGGING_TYPE_CONSTANTS = { panelResizer: "panelResizer" };
...
function useDrag(draggingItemType, { onInit, onDragStart, onDrag, onMouseUp, onPressESCKey } = {}) {
	...
	const dndSliceRef = s$2(useInternalStore().getState().dnd);
	...
	const handleMouseDown = T$1((e2) => {
		if (!isLeftClick(e2.button)) return;
		if (e2.currentTarget) e2.currentTarget.ondragstart = function() {
			return false;
		};
		e2.preventDefault();
		setStarted(true);
	...
	const handleMouseMove = T$1((e2) => {
		const { initX, initY, draggingState, draggingItemType: currentDraggingItemType } = dndSliceRef.current;
		if (currentDraggingItemType !== draggingItemType) {
			setStarted(false);
			reset();
			return;
		}
		if (isPresent(initX) && isPresent(initY) && !isMouseMoved(initX, initY, e2.clientX, e2.clientY)) return;
		if (draggingState <= DraggingState.INIT) {
			setDragging({
				x: e2.clientX,
				y: e2.clientY
			});
			onDragStart?.(e2, dndSliceRef.current);
			return;
		}
		setDragging({
			x: e2.clientX,
	...
	const handleMouseUp = T$1((e2) => {
		e2.stopPropagation();
		if (isStarted) {
			onMouseUp?.(e2, dndSliceRef.current);
			setStarted(false);
			reset();
		}
	}, [
	...
	const handleKeyDown = T$1((e2) => {
		if (isKeyPressed(e2, KEY.ESCAPE)) {
			setStarted(false);
			cancelDrag();
			onPressESCKey?.(e2, dndSliceRef.current);
		}
...
function getEventItemStyle({ uiModel, flat, eventHeight, isDraggingTarget, calendarColor }) {
	...
	const defaultItemStyle = {
		...
		opacity: isDraggingTarget ? .5 : 1
	};
	const margins = getMargins(flat);
	return flat ? __spreadValues({ marginTop: margins.vertical }, defaultItemStyle) : __spreadValues({
		marginLeft: exceedLeft ? 0 : margins.horizontal,
		marginRight: exceedRight ? 0 : margins.horizontal
	}, defaultItemStyle);
}
function getContainerStyle({ flat, uiModel, resizingWidth, movingLeft, eventHeight, headerHeight }) {
...
function getTestId({ model }) {
	return `${model.calendarId ? `${model.calendarId}-` : ""}${model.id ? `${model.id}-` : ""}${model.title}`;
}
var classNames$k = {
...
function HorizontalEvent({ flat = false, uiModel, eventHeight, headerHeight, resizingWidth = null, movingLeft = null }) {
	...
	const startDragEvent = (className2) => {
		...
		layoutContainer?.classList.add(className2);
	};
	const endDragEvent = (className2) => {
		setIsDraggingTarget(false);
		layoutContainer?.classList.remove(className2);
	};
	useTransientUpdate(dndSelector, ({ draggingEventUIModel, draggingState }) => {
		if (draggingState === DraggingState.DRAGGING && (draggingEventUIModel == null ? void 0 : draggingEventUIModel.cid()) === uiModel.cid() && isNil(resizingWidth) && isNil(movingLeft)) setIsDraggingTarget(true);
		else setIsDraggingTarget(false);
	});
	_$2(() => {
		if (isDraggableEvent2) eventBus.fire("afterRenderEvent", uiModel.model.toEventObject());
	}, []);
	...
	const handleResizeStart = (e2) => {
		e2.stopPropagation();
		if (isDraggableEvent2) onResizeStart(e2);
	};
	...
	}) : null, /* @__PURE__ */ h$3("span", { className: classNames$k.eventTitle }, /* @__PURE__ */ h$3(Template, {
		template: uiModel.model.category,
		param: uiModel.model
	})), !shouldHideResizeHandler ? /* @__PURE__ */ h$3(HorizontalEventResizeIcon, { onMouseDown: handleResizeStart }) : null));
}
...
function useCurrentPointerPositionInGrid(gridPositionFinder) {
	...
	useTransientUpdate(dndSelector, (dndState) => {
		if (isPresent(dndState.x) && isPresent(dndState.y)) {
			...
			if (gridPosition) setCurrentGridPos(gridPosition);
		}
	});
	return [currentGridPos, T$1(() => setCurrentGridPos(null), [])];
}
...
function useDraggingEvent(area, behavior) {
	...
	useTransientUpdate(dndSelector, ({ draggingItemType, draggingEventUIModel, draggingState }) => {
		...
		if (isNil(draggingEvent) && hasMatchingTargetEvent) setDraggingEvent(draggingEventUIModel);
...
function useAlldayGridRowEventMove({ rowStyleInfo, gridPositionFinder }) {
	const eventBus = useEventBus();
	const { isDraggingEnd, isDraggingCanceled, draggingEvent: movingEvent, clearDraggingEvent } = useDraggingEvent("dayGrid", "move");
	...
	const currentMovingLeft = F$2(() => {
		if (isNil(columnIndex) || isNil(startGridXRef.current) || isNil(targetEventStartGridX)) return null;
	...
	_$2(() => {
		if (isNil(startGridXRef.current) && isPresent(columnIndex)) startGridXRef.current = columnIndex;
	}, [columnIndex]);
	useWhen(() => {
		if (!isDraggingCanceled && isPresent(movingEvent) && isPresent(columnIndex) && isPresent(currentMovingLeft) && columnIndex !== startGridXRef.current && isPresent(startGridXRef.current)) {
...
function MovingEventShadow$2({ rowStyleInfo, gridPositionFinder }) {
	const { movingEvent, movingLeft } = useAlldayGridRowEventMove({
		rowStyleInfo,
		gridPositionFinder
	});
	if (isNil(movingEvent)) return null;
...
function getEventColIndex(uiModel, row) {
	return {
		start: getGridDateIndex(uiModel.getStarts(), row),
		end: getGridDateIndex(uiModel.getEnds(), row)
	};
}
function useAlldayGridRowEventResize({ weekDates, gridColWidthMap, gridPositionFinder }) {
	const eventBus = useEventBus();
	const { isDraggingEnd, isDraggingCanceled, draggingEvent: resizingEvent, clearDraggingEvent } = useDraggingEvent("dayGrid", "resize");
	const [currentGridPos, clearCurrentGridPos] = useCurrentPointerPositionInGrid(gridPositionFinder);
	const { columnIndex } = currentGridPos != null ? currentGridPos : {};
	const targetEventGridIndices = F$2(() => {
		if (resizingEvent) return getEventColIndex(resizingEvent, weekDates);
		return {
			start: -1,
			end: -1
		};
	...
	const resizingWidth = F$2(() => {
		if (targetEventGridIndices.start > -1 && isPresent(columnIndex)) return gridColWidthMap[targetEventGridIndices.start][columnIndex];
		return null;
	}, [
		columnIndex,
		gridColWidthMap,
	...
	useWhen(() => {
		if (!isDraggingCanceled && isPresent(resizingEvent) && isPresent(columnIndex) && targetEventGridIndices.start <= columnIndex && targetEventGridIndices.end !== columnIndex) {
...
function ResizingEventShadow({ weekDates, gridColWidthMap, gridPositionFinder }) {
	...
	if (isNil(resizingEvent)) return null;
	return /* @__PURE__ */ h$3(HorizontalEvent, {
...
function useClickPrevention({ onClick, onDblClick, delay = 300 }) {
...
function useGridSelection({ type, selectionSorter, dateGetter, dateCollection, gridPositionFinder }) {
	...
	const setGridSelectionByPosition = (e2) => {
		...
		if (isPresent(initGridPosition) && isPresent(gridPosition)) setGridSelection(type, selectionSorter(initGridPosition, gridPosition));
	};
	const [handleClickWithDebounce, handleDblClickPreventingClick] = useClickPrevention({
		onClick: (e2) => {
			if (enableClick) onMouseUp(e2, true);
		},
		onDblClick: (e2) => {
			if (enableDblClick) onMouseUp(e2, true);
		},
		delay: 250
	});
	const onMouseUpWithClick = (e2) => {
		const isClick = e2.detail <= 1;
		if (!enableClick && (!enableDblClick || isClick)) return;
		if (enableClick) {
			if (isClick) handleClickWithDebounce(e2);
			else handleDblClickPreventingClick(e2);
			return;
		}
		onMouseUp(e2, true);
	};
	const onMouseUp = (e2, isClickEvent) => {
		var _a;
		if (isClickEvent) setGridSelectionByPosition(e2);
	...
	const onMouseDown = useDrag(currentGridSelectionType, {
		onInit: (e2) => {
			...
			const gridPosition = gridPositionFinder(e2);
			if (isPresent(gridPosition)) setInitGridPosition(gridPosition);
			if (!useFormPopup) addGridSelection(type, gridSelectionRef.current);
		},
		onDragStart: (e2) => {
			setGridSelectionByPosition(e2);
		},
		onDrag: (e2) => {
			if (isSelectingGridRef.current) setGridSelectionByPosition(e2);
		},
		onMouseUp: (e2, { draggingState }) => {
			e2.stopPropagation();
			const isClickEvent = draggingState <= DraggingState.INIT;
			if (isClickEvent) onMouseUpWithClick(e2);
			else onMouseUp(e2, isClickEvent);
		},
...
function AlldayGridRow({ events, weekDates, height = DEFAULT_PANEL_HEIGHT, options = {}, rowStyleInfo, gridColWidthMap }) {
	...
	const onMouseDown = (e2) => {
		...
		if (isReadOnly || !target.classList.contains(cls("panel-grid"))) return;
	...
	return /* @__PURE__ */ h$3(p$3, null, /* @__PURE__ */ h$3("div", {
		...
		onMouseDown
	}, /* @__PURE__ */ h$3("div", { className: cls("panel-grid-wrapper") }, /* @__PURE__ */ h$3(GridCells, {
		uiModels: events,
		weekDates,
		narrowWeekend,
		height,
		...
		onClickExceedCount,
		onClickCollapseButton
	})), /* @__PURE__ */ h$3("div", { className: cls(`panel-allday-events`) }, horizontalEvents), /* @__PURE__ */ h$3(ResizingEventShadow, {
		weekDates,
		gridPositionFinder,
		gridColWidthMap
...
function OtherGridRow({ events, weekDates, category, height = DEFAULT_PANEL_HEIGHT, options = {} }) {
	const dayGridLeftTheme = useTheme(weekDayGridLeftSelector);
	const maxTop = F$2(() => Math.max(0, ...events.map(({ top }) => top)), [events]);
	...
	return /* @__PURE__ */ h$3(p$3, null, /* @__PURE__ */ h$3("div", {
		...
		param: category
	})), /* @__PURE__ */ h$3("div", { className: cls("allday-panel") }, /* @__PURE__ */ h$3("div", { className: cls("panel-grid-wrapper") }, /* @__PURE__ */ h$3(GridCells, {
		uiModels: events,
		weekDates,
		narrowWeekend,
		height,
		...
		onClickExceedCount,
		onClickCollapseButton
	})), /* @__PURE__ */ h$3("div", { className: cls(`panel-${category}-events`) }, horizontalEvents)));
}
var classNames$j = {
...
function EventDetailSectionDetail({ event }) {
	...
	return /* @__PURE__ */ h$3("div", { className: classNames$j.sectionDetail }, location2 && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItem }, /* @__PURE__ */ h$3("span", { className: classNames$j.locationIcon }), /* @__PURE__ */ h$3("span", { className: classNames$j.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupDetailLocation",
		param: event,
		as: "span"
	}))), recurrenceRule && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItem }, /* @__PURE__ */ h$3("span", { className: classNames$j.repeatIcon }), /* @__PURE__ */ h$3("span", { className: classNames$j.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupDetailRecurrenceRule",
		param: event,
		as: "span"
	}))), attendees && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItemIndent }, /* @__PURE__ */ h$3("span", { className: classNames$j.userIcon }), /* @__PURE__ */ h$3("span", { className: classNames$j.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupDetailAttendees",
		param: event,
		as: "span"
	}))), state && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItem }, /* @__PURE__ */ h$3("span", { className: classNames$j.stateIcon }), /* @__PURE__ */ h$3("span", { className: classNames$j.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupDetailState",
		param: event,
		as: "span"
	}))), calendar && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItem }, /* @__PURE__ */ h$3("span", {
		className: classNames$j.calendarDotIcon,
		style: { backgroundColor: (_a = calendar == null ? void 0 : calendar.backgroundColor) != null ? _a : "" }
	}), /* @__PURE__ */ h$3("span", { className: classNames$j.content }, (_b = calendar == null ? void 0 : calendar.name) != null ? _b : "")), body && /* @__PURE__ */ h$3("div", { className: classNames$j.detailItemSeparate }, /* @__PURE__ */ h$3("span", { className: classNames$j.content }, /* @__PURE__ */ h$3(Template, {
...
function EventDetailSectionHeader({ event }) {
	return /* @__PURE__ */ h$3("div", { className: classNames$i.sectionHeader }, /* @__PURE__ */ h$3("div", { className: classNames$i.eventTitle }, /* @__PURE__ */ h$3(Template, {
		template: "popupDetailTitle",
		param: event,
		as: "span"
	})), /* @__PURE__ */ h$3("div", { className: classNames$i.content }, /* @__PURE__ */ h$3(Template, {
...
var FloatingLayerContext = B$1(null);
function FloatingLayerProvider({ children }) {
	...
	return /* @__PURE__ */ h$3(FloatingLayerContext.Provider, { value: floatingLayer }, children, /* @__PURE__ */ h$3("div", {
...
var useFloatingLayer = (floatingLayerType) => {
	...
	if (isUndefined_1(floatingLayers)) throw new Error("FloatingLayerProvider is not found");
...
function calculatePopupPosition$1(eventRect, layoutRect, popupRect) {
	...
	if (isTopOutOfLayout(top, layoutRect, popupRect)) top = layoutRect.top + layoutRect.height - popupRect.height;
	if (isLeftOutOfLayout(left, layoutRect, popupRect)) left = eventRect.left - popupRect.width;
...
function calculatePopupArrowPosition(eventRect, layoutRect, popupRect) {
	return {
		top: eventRect.top + eventRect.height / 2 + window.scrollY,
		direction: eventRect.left + eventRect.width + popupRect.width > layoutRect.left + layoutRect.width ? DetailPopupArrowDirection.right : DetailPopupArrowDirection.left
	};
}
function EventDetailPopup() {
	...
	const popupArrowClassName = F$2(() => {
		return cls("popup-arrow", {
			right: arrowDirection === DetailPopupArrowDirection.right,
			left: arrowDirection === DetailPopupArrowDirection.left
		});
	}, [arrowDirection]);
	h$2(() => {
	...
	if (isNil(event) || isNil(eventRect) || isNil(detailPopupSlot)) return null;
	const { title = "", isAllday: isAllday2 = false, start = new TZDate(), end = new TZDate(), location: location2, state, isReadOnly, isPrivate } = event;
	const popupArrowPointPosition = {
		top: eventRect.top + eventRect.height / 2,
		left: eventRect.left + eventRect.width / 2
	};
	const onClickEditButton = () => {
		if (useFormPopup) showFormPopup({
		...
		else eventBus.fire("beforeUpdateEvent", {
	...
	return V(/* @__PURE__ */ h$3("div", {
		...
		style
	}, /* @__PURE__ */ h$3("div", { className: classNames$h.detailContainer }, /* @__PURE__ */ h$3(EventDetailSectionHeader, { event }), /* @__PURE__ */ h$3(EventDetailSectionDetail, { event }), !isReadOnly && /* @__PURE__ */ h$3("div", { className: classNames$h.sectionButton }, /* @__PURE__ */ h$3("button", {
		type: "button",
		className: classNames$h.editButton,
		onClick: onClickEditButton
	}, /* @__PURE__ */ h$3("span", { className: classNames$h.editIcon }), /* @__PURE__ */ h$3("span", { className: classNames$h.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupEdit",
		as: "span"
	}))), /* @__PURE__ */ h$3("div", { className: classNames$h.verticalLine }), /* @__PURE__ */ h$3("button", {
		type: "button",
		className: classNames$h.deleteButton,
		onClick: onClickDeleteButton
	}, /* @__PURE__ */ h$3("span", { className: classNames$h.deleteIcon }), /* @__PURE__ */ h$3("span", { className: classNames$h.content }, /* @__PURE__ */ h$3(Template, {
		template: "popupDelete",
		as: "span"
	}))))), /* @__PURE__ */ h$3("div", {
		className: classNames$h.topLine,
		style: { backgroundColor: calendarColor.backgroundColor }
	}), /* @__PURE__ */ h$3("div", { className: popupArrowClassName }, /* @__PURE__ */ h$3("div", {
		className: classNames$h.border,
		style: { top: arrowTop }
	}, /* @__PURE__ */ h$3("div", { className: classNames$h.fill })))), detailPopupSlot);
}
var classNames$g = {
...
function DropdownMenuItem({ index, name, backgroundColor, onClick }) {
	...
	}), /* @__PURE__ */ h$3("span", { className: classNames$g.content }, name));
}
function CalendarDropdownMenu({ calendars, setOpened, onChangeIndex }) {
	...
	return /* @__PURE__ */ h$3("ul", { className: classNames$g.dropdownMenu }, calendars.map(({ name, backgroundColor = "000" }, index) => /* @__PURE__ */ h$3(DropdownMenuItem, {
...
function PopupSection({ children, classNames: classNames2 = [], onClick = noop }) {
	return /* @__PURE__ */ h$3("div", {
...
function formStateReducer(state, action) {
	switch (action.type) {
		case "init": return __spreadValues(__spreadValues({}, defaultFormState), action.event);
		case "setCalendarId": return __spreadProps(__spreadValues({}, state), { calendarId: action.calendarId });
		case "setTitle": return __spreadProps(__spreadValues({}, state), { title: action.title });
		case "setLocation": return __spreadProps(__spreadValues({}, state), { location: action.location });
		case "setPrivate": return __spreadProps(__spreadValues({}, state), { isPrivate: action.isPrivate });
		case "setAllday": return __spreadProps(__spreadValues({}, state), { isAllday: action.isAllday });
		case "setState": return __spreadProps(__spreadValues({}, state), { state: action.state });
		case "reset": return __spreadValues(__spreadValues({}, state), defaultFormState);
...
function CalendarSelector({ calendars, selectedCalendarId, formStateDispatch }) {
	...
	return /* @__PURE__ */ h$3(PopupSection, {
		...
		style: { backgroundColor }
	}), /* @__PURE__ */ h$3("span", { className: classNames$f.content }, name), /* @__PURE__ */ h$3("span", { className: cls("icon", "ic-dropdown-arrow", { open: isOpened }) })), isOpened && /* @__PURE__ */ h$3(CalendarDropdownMenu, {
		calendars,
		setOpened,
...
function ClosePopupButton({ type, close }) {
	...
	const onClickHandler = () => {
		hideAllPopup();
		if (isFunction$2(close)) close();
	};
	return /* @__PURE__ */ h$3("button", {
		type: "button",
		className: classNames$e.closeButton,
		onClick: onClickHandler
	}, type === "moreEvents" ? /* @__PURE__ */ h$3(Template, { template: "monthMoreClose" }) : /* @__PURE__ */ h$3("i", { className: classNames$e.closeIcon }));
}
var classNames$d = { confirmButton: cls("popup-button", "popup-confirm") };
...
function useStringOnlyTemplate({ template, model, defaultValue = "" }) {
	const templateFunc = useStore(templateSelector)[template];
	if (isNil(templateFunc)) return defaultValue;
	let result = templateFunc(model);
	if (!isString_1(result)) result = defaultValue;
	return result;
}
var classNames$c = {
...
var DateSelector = R(function DateSelector2({ start, end, isAllday: isAllday2 = false, formStateDispatch }, ref) {
	...
	return /* @__PURE__ */ h$3(PopupSection, null, /* @__PURE__ */ h$3("div", { className: classNames$c.datePicker }, /* @__PURE__ */ h$3("span", { className: classNames$c.dateIcon }), /* @__PURE__ */ h$3("input", {
		name: "start",
	...
	})), /* @__PURE__ */ h$3("span", { className: classNames$c.dateDash }, "-"), /* @__PURE__ */ h$3("div", { className: classNames$c.datePicker }, /* @__PURE__ */ h$3("span", { className: classNames$c.dateIcon }), /* @__PURE__ */ h$3("input", {
		name: "end",
		className: classNames$c.content,
	...
	}, /* @__PURE__ */ h$3("span", { className: cls("icon", {
		"ic-checkbox-normal": !isAllday2,
		"ic-checkbox-checked": isAllday2
	}) }), /* @__PURE__ */ h$3("span", { className: classNames$c.content }, /* @__PURE__ */ h$3(Template, { template: "popupIsAllday" })), /* @__PURE__ */ h$3("input", {
		name: "isAllday",
		type: "checkbox",
...
function StateDropdownMenu({ setOpened, setEventState }) {
	...
	return /* @__PURE__ */ h$3("ul", { className: classNames$b.dropdownMenu }, EVENT_STATES.map((state) => /* @__PURE__ */ h$3("li", {
		key: state,
		className: classNames$b.popupSectionItem,
		onClick: (e2) => onClickDropdown(e2, state)
	}, /* @__PURE__ */ h$3("span", { className: classNames$b.icon }), /* @__PURE__ */ h$3("span", { className: classNames$b.content }, state === "Busy" ? /* @__PURE__ */ h$3(Template, { template: "popupStateBusy" }) : /* @__PURE__ */ h$3(Template, { template: "popupStateFree" })))));
}
var classNames$a = {
...
function EventStateSelector({ eventState = "Busy", formStateDispatch }) {
	...
	}, /* @__PURE__ */ h$3("span", { className: classNames$a.stateIcon }), /* @__PURE__ */ h$3("span", { className: classNames$a.content }, eventState === "Busy" ? /* @__PURE__ */ h$3(Template, { template: "popupStateBusy" }) : /* @__PURE__ */ h$3(Template, { template: "popupStateFree" })), /* @__PURE__ */ h$3("span", { className: classNames$a.arrowIcon })), isOpened && /* @__PURE__ */ h$3(StateDropdownMenu, {
		setOpened,
...
function LocationInputBox({ location: location2, formStateDispatch }) {
	...
	return /* @__PURE__ */ h$3(PopupSection, null, /* @__PURE__ */ h$3("div", { className: classNames$9.popupSectionItem }, /* @__PURE__ */ h$3("span", { className: classNames$9.locationIcon }), /* @__PURE__ */ h$3("input", {
		name: "location",
...
function TitleInputBox({ title, isPrivate = false, formStateDispatch }) {
	...
	return /* @__PURE__ */ h$3(PopupSection, null, /* @__PURE__ */ h$3("div", { className: classNames$8.popupSectionItem }, /* @__PURE__ */ h$3("span", { className: classNames$8.titleIcon }), /* @__PURE__ */ h$3("input", {
		name: "title",
...
function calculatePopupPosition(popupArrowPointPosition, layoutRect, popupRect) {
	...
	if (isTopOutOfLayout(top, layoutRect, popupRect)) top = layoutRect.top + layoutRect.height - popupRect.height;
	if (isLeftOutOfLayout(left, layoutRect, popupRect)) left = layoutRect.left + layoutRect.width - popupRect.width;
	return {
...
function getChanges(event, eventObject) {
	return Object.entries(eventObject).reduce((changes, [key, value]) => {
		...
		if (event[eventObjectKey] instanceof TZDate) {
			if (compare(event[eventObjectKey], value) !== 0) changes[eventObjectKey] = value;
		} else if (event[eventObjectKey] !== value) changes[eventObjectKey] = value;
		return changes;
	}, {});
}
function EventFormPopup() {
	...
	const popupArrowClassName = F$2(() => {
		return cls("popup-arrow", {
			top: arrowDirection === FormPopupArrowDirection.top,
			bottom: arrowDirection === FormPopupArrowDirection.bottom
		});
	}, [arrowDirection]);
	h$2(() => {
		if (popupContainerRef.current && popupArrowPointPosition && layoutContainer) {
			const { top, left, direction } = calculatePopupPosition(popupArrowPointPosition, layoutContainer.getBoundingClientRect(), popupContainerRef.current.getBoundingClientRect());
	...
	_$2(() => {
		if (isPresent(popupParams) && isPresent(event)) formStateDispatch({
	...
	_$2(() => {
		if (isNil(popupParams)) formStateDispatch({ type: FormStateActionType.reset });
	}, [formStateDispatch, popupParams]);
	if (isNil(start) || isNil(end) || isNil(formPopupSlot)) return null;
	const onSubmit = (e2) => {
		var _a2, _b;
		e2.preventDefault();
		...
		if (isCreationPopup) eventBus.fire("beforeCreateEvent", eventData);
		else if (event) {
	...
	return V(/* @__PURE__ */ h$3("div", {
		...
		ref: popupContainerRef,
		style
	}, /* @__PURE__ */ h$3("form", { onSubmit }, /* @__PURE__ */ h$3("div", { className: classNames$7.formContainer }, (calendars == null ? void 0 : calendars.length) ? /* @__PURE__ */ h$3(CalendarSelector, {
		...
		type: "form",
		close
	}), /* @__PURE__ */ h$3(PopupSection, null, /* @__PURE__ */ h$3(ConfirmPopupButton, null, isCreationPopup ? /* @__PURE__ */ h$3(Template, { template: "popupSave" }) : /* @__PURE__ */ h$3(Template, { template: "popupUpdate" })))), /* @__PURE__ */ h$3("div", { className: popupArrowClassName }, /* @__PURE__ */ h$3("div", {
		className: classNames$7.popupArrowBorder,
		style: { left: arrowLeft }
	}, /* @__PURE__ */ h$3("div", { className: classNames$7.popupArrowFill }))))), formPopupSlot);
}
...
function PopupOverlay() {
	...
	const onClick = (ev) => {
		var _a;
		ev.stopPropagation();
		(_a = shownPopupParam == null ? void 0 : shownPopupParam.close) == null || _a.call(shownPopupParam);
		hideAllPopup();
	};
	return /* @__PURE__ */ h$3("div", {
...
function SeeMoreEventsPopup() {
	...
	_$2(() => {
		if (!isHidden && moreEventsPopupContainerRef.current) eventBus.fire("clickMoreEventsBtn", {
			date: date2.toDate(),
	...
	const moreViewListStyle = { height: `calc(100% - ${MONTH_MORE_VIEW_HEADER_HEIGHT + MONTH_MORE_VIEW_HEADER_MARGIN_BOTTOM + MONTH_MORE_VIEW_HEADER_PADDING_TOP}px)` };
	return V(/* @__PURE__ */ h$3("div", {
		role: "dialog",
		...
		param: moreTitle
	}), /* @__PURE__ */ h$3(ClosePopupButton, { type: "moreEvents" })), /* @__PURE__ */ h$3("div", {
...
function Layout({ children, width, height, className: className2 = "", autoAdjustPanels = false }) {
	...
	h$2(() => {
		if (container && autoAdjustPanels) {
			...
			if (!isString_1(lastChild) && !isNumber_1(lastChild) && !isNil(lastChild)) setLastPanelType(lastChild.props.name);
		}
	}, [
		children,
		setLastPanelType,
	...
	return /* @__PURE__ */ h$3(LayoutContainerProvider, { value: container }, /* @__PURE__ */ h$3("div", {
		ref: containerRefCallback,
...
function PanelResizer({ name, height }) {
	const style = getDefaultStyle(height, useTheme(T$1((theme) => theme.week.panelResizer.border, [])));
	...
	return /* @__PURE__ */ h$3("div", { style: { position: "relative" } }, /* @__PURE__ */ h$3("div", {
...
function getPanelStyle({ initialHeight, initialWidth, overflowX, overflowY, maxExpandableWidth, maxExpandableHeight, minHeight, maxHeight, minWidth, maxWidth }) {
	const style = {};
	if (initialWidth) {
	...
	if (overflowX) style.overflowX = "auto";
	if (overflowY) style.overflowY = "auto";
...
var Panel = R(function Panel2({ name, initialWidth = DEFAULT_PANEL_HEIGHT, initialHeight = DEFAULT_PANEL_HEIGHT, overflowX, overflowY, maxExpandableWidth, maxExpandableHeight, minHeight, maxHeight, minWidth, maxWidth, resizerWidth = DEFAULT_RESIZER_LENGTH, resizerHeight = DEFAULT_RESIZER_LENGTH, resizable, children }, ref) {
	const { updateDayGridRowHeight } = useDispatch("weekViewLayout");
	...
	const isResizable = F$2(() => {
		if (isNil(resizable) || isBoolean_1(resizable)) return !!resizable;
...
function getContainerWidth(width, marginLeft) {
	if (isString_1(width)) return width;
	if (width >= 0) return `calc(${toPercent(width)} - ${marginLeft}px)`;
	return "";
}
function getStyles({ uiModel, isDraggingTarget, hasNextStartTime, calendarColor, minHeight }) {
	const { top, left, height, width, duplicateLeft, duplicateWidth, goingDurationHeight, modelDurationHeight, comingDurationHeight, croppedStart, croppedEnd } = uiModel;
	...
	const modelDurationStyle = { height: toPercent(modelDurationHeight) };
...
function isDraggableEvent({ uiModel, isReadOnlyCalendar, isDraggingTarget, hasNextStartTime }) {
	const { model } = uiModel;
	return !isReadOnlyCalendar && !model.isReadOnly && !isDraggingTarget && !hasNextStartTime;
}
function TimeEvent({ uiModel, nextStartTime, isResizingGuide = false, minHeight = 0 }) {
	const { useDetailPopup, isReadOnly: isReadOnlyCalendar, week: weekOptions } = useStore(optionsSelector);
	const calendarColor = useCalendarColor(uiModel.model);
	...
	useTransientUpdate(dndSelector, ({ draggingEventUIModel, draggingState }) => {
		if (draggingState === DraggingState.DRAGGING && (draggingEventUIModel == null ? void 0 : draggingEventUIModel.cid()) === uiModel.cid() && !hasNextStartTime && !isResizingGuide) setIsDraggingTarget(true);
		else setIsDraggingTarget(false);
	});
	_$2(() => {
		if (!isResizingGuide) eventBus.fire("afterRenderEvent", uiModel.model.toEventObject());
	}, []);
	const startDragEvent = (className2) => {
		setDraggingEventUIModel(uiModel);
		layoutContainer?.classList.add(className2);
	...
	const onMoveStart = useDrag(DRAGGING_TYPE_CREATORS.moveEvent("timeGrid", `${uiModel.cid()}`), {
		onDragStart: () => {
			if (isDraggable) startDragEvent(classNames$5.moveEvent);
		},
		onMouseUp: (e2, { draggingState }) => {
			endDragEvent(classNames$5.moveEvent);
			const isClick = draggingState <= DraggingState.INIT;
			if (isClick && collapseDuplicateEvents) setSelectedDuplicateEventCid(uiModel.duplicateEvents.length > 0 ? uiModel.cid() : DEFAULT_DUPLICATE_EVENT_CID);
			if (isClick && useDetailPopup && eventContainerRef.current) showDetailPopup({
				event: uiModel.model,
				eventRect: eventContainerRef.current.getBoundingClientRect()
			}, false);
	...
	return /* @__PURE__ */ h$3("div", {
		...
		template: "time",
		param: __spreadProps(__spreadValues({}, model.toEventObject()), { start: hasNextStartTime ? nextStartTime : model.start })
...
function GridSelectionByColumn({ columnIndex, timeGridRows }) {
	...
	const gridSelectionProps = F$2(() => {
		if (!gridSelectionData) return null;
		...
		const { top: endRowTop, height: endRowHeight, endTime: endRowEndTime } = timeGridRows[endRowIndex];
		const gridSelectionHeight = endRowTop + endRowHeight - startRowTop;
		let text = `${startRowStartTime} - ${endRowEndTime}`;
		if (isSelectingMultipleColumns) text = isStartingColumn ? startRowStartTime : "";
		return {
			top: startRowTop,
	...
	if (isNil(gridSelectionProps)) return null;
	return /* @__PURE__ */ h$3(GridSelection, __spreadValues({}, gridSelectionProps));
}
function useTimeGridEventResize({ gridPositionFinder, totalUIModels, columnIndex, timeGridData }) {
	const eventBus = useEventBus();
	const { isDraggingEnd, isDraggingCanceled, draggingEvent: resizingStartUIModel, clearDraggingEvent } = useDraggingEvent("timeGrid", "resize");
	const [currentGridPos, clearCurrentGridPos] = useCurrentPointerPositionInGrid(gridPositionFinder);
	...
	_$2(() => {
		if (canCalculateGuideUIModel) {
			...
			if ((columnIndex === eventStartDateColumnIndex || columnIndex === eventEndDateColumnIndex) && eventStartDateColumnIndex !== eventEndDateColumnIndex) {
				let clonedUIModel;
				if (columnIndex === eventStartDateColumnIndex) clonedUIModel = resizeTargetUIModelColumns[columnIndex][0].clone();
				else {
					clonedUIModel = resizingStartUIModel.clone();
					clonedUIModel.setUIProps({ height: timeGridData.rows[currentGridPos.rowIndex].top + oneRowHeight });
				}
				setGuideUIModel(clonedUIModel);
			}
		}
	...
	useWhen(() => {
		if (!isDraggingCanceled && isPresent(baseResizingInfo) && isPresent(currentGridPos) && isPresent(resizingStartUIModel) && baseResizingInfo.eventEndDateColumnIndex === columnIndex) {
			...
			eventBus.fire("beforeUpdateEvent", {
				...
				changes: { end: max(minEndDate, targetEndDate) }
			});
		}
		clearStates();
	}, isDraggingEnd);
...
function ResizingGuideByColumn({ gridPositionFinder, totalUIModels, columnIndex, timeGridData }) {
	...
	if (isNil(guideUIModel)) return null;
...
function VerticalEvents({ eventUIModels, minEventHeight }) {
	return /* @__PURE__ */ h$3("div", {
...
function getBackgroundColor({ today, columnDate, defaultBackgroundColor, todayBackgroundColor, weekendBackgroundColor }) {
	const isTodayColumn = isSameDate(today, columnDate);
	const isWeekendColumn = isWeekend(columnDate.getDay());
	if (isTodayColumn) return todayBackgroundColor;
	if (isWeekendColumn) return weekendBackgroundColor;
	return defaultBackgroundColor;
}
var Column = g$1(function Column2({ columnDate, columnWidth, columnIndex, totalUIModels, gridPositionFinder, timeGridData, isLastColumn }) {
	...
	const style = {
		width: columnWidth,
		backgroundColor: getBackgroundColor(__spreadValues({
			today: getNow(),
			columnDate
...
var GridLines = g$1(function GridLines2({ timeGridRows }) {
	const { halfHourLineBorder, hourLineBorder } = useTheme(gridLineBorderSelector);
	return /* @__PURE__ */ h$3("div", { className: cls("gridlines") }, timeGridRows.map((time, index) => {
...
function getMovingEventPosition({ draggingEvent, columnDiff, rowDiff, timeGridDataRows, currentDate }) {
	...
	return {
		top: isStartAtPrevDate ? 0 : timeGridDataRows[startIndex].top,
		height: isEndAtNextDate ? maxHeight : Math.max(indexDiff, 1) * rowHeight
	};
}
var initXSelector = (state) => state.dnd.initX;
var initYSelector = (state) => state.dnd.initY;
function useTimeGridEventMove({ gridPositionFinder, timeGridData }) {
	...
	_$2(() => {
		if (isPresent(initX) && isPresent(initY)) initGridPosRef.current = gridPositionFinder({
			clientX: initX,
			clientY: initY
		});
	}, [
	...
	const gridDiff = F$2(() => {
		if (isNil(initGridPosRef.current) || isNil(currentGridPos)) return null;
		return {
	...
	const startDateTime = F$2(() => {
		if (isNil(draggingEvent)) return null;
	...
	const nextStartTime = F$2(() => {
		if (isNil(gridDiff) || isNil(startDateTime)) return null;
	...
	const movingEvent = F$2(() => {
		if (isNil(draggingEvent) || isNil(currentGridPos) || isNil(gridDiff)) return null;
	...
	useWhen(() => {
		if (!isDraggingCanceled && isPresent(draggingEvent) && isPresent(currentGridPos) && isPresent(gridDiff) && isPresent(nextStartTime) && (gridDiff.rowDiff !== 0 || gridDiff.columnDiff !== 0)) {
			const nextEndTime = addMilliseconds(nextStartTime, draggingEvent.duration());
			eventBus.fire("beforeUpdateEvent", {
...
function MovingEventShadow$1({ gridPositionFinder, timeGridData }) {
	...
	_$2(() => {
		const scrollToNow = (behavior) => {
			...
			if (scrollArea && indicatorRef.current) {
				...
				if (scrollArea.scrollTo) scrollArea.scrollTo({
					top: newScrollTop,
					behavior
				});
				else scrollArea.scrollTop = newScrollTop;
			}
		};
...
function NowIndicatorLabel({ unit, top, now, zonedNow }) {
	...
	}, dateDifference !== 0 && /* @__PURE__ */ h$3("span", { className: cls(classNames$2.dayDifference) }, `[${dateDifference > 0 ? "+" : "-"}${Math.abs(dateDifference)}]`), /* @__PURE__ */ h$3(Template, {
...
function HourRows({ rowsInfo, isPrimary, borderRight, width, nowIndicatorState }) {
	...
	return /* @__PURE__ */ h$3("div", {
		...
		const color = isPresent(zonedNow) && date2 < zonedNow ? pastTimeColor : futureTimeColor;
		return /* @__PURE__ */ h$3("div", {
			key: date2.getTime(),
...
var TimeColumn = g$1(function TimeColumn2({ timeGridRows, nowIndicatorState }) {
	const showNowIndicator = useStore(showNowIndicatorOptionSelector);
	...
	const hourRowsPropsMapper = T$1((row, index, diffFromPrimaryTimezone) => {
		const shouldHideRow = ({ top: rowTop, height: rowHeight }) => {
			if (!showNowIndicator || isNil(nowIndicatorState)) return false;
		...
		if (isPresent(diffFromPrimaryTimezone)) date2 = addMinutes(date2, diffFromPrimaryTimezone);
		return {
			date: date2,
			top: row.top,
			className: className2,
	...
	const otherTimezoneHourRowsProps = F$2(() => {
		if (otherTimezones.length === 0) return [];
		return otherTimezones.reverse().map((timezone) => {
			...
			const diffFromPrimaryTimezone = tzConverter(timezoneName).getTimezoneOffset() - primaryTimezoneOffset;
...
function getTopPercentByTime(date2, start, end) {
	...
	return limit(ratio(endTime - startTime, 100, time), [0], [100]);
}
...
function isBetween(startColumnTime, endColumnTime) {
	return (uiModel) => {
		...
		return !(addMinutes(uiModel.getEnds(), comingDuration) <= startColumnTime || ownStarts >= endColumnTime);
	};
}
...
function setCroppedEdges(uiModel, options) {
	...
	if (goingStart < startColumnTime) uiModel.croppedStart = true;
	if (comingEnd > endColumnTime) uiModel.croppedEnd = true;
}
function getDuplicateLeft(uiModel, baseLeft) {
	...
	if (prevEvent) {
		...
		if (percent !== 0) left = `calc(${toPercent(percent)} ${px > 0 ? "+" : "-"} ${toPx(Math.abs(px))})`;
		else left = toPx(px);
	} else left = toPercent(left);
	return left;
}
...
function getRenderInfoOptions(uiModel, columnIndex, baseWidth, startColumnTime, endColumnTime) {
	...
	return {
		...
		modelStart,
		modelEnd,
		renderStart: max(goingStart, startColumnTime),
		renderEnd: min(comingEnd, endColumnTime),
		goingStart,
		comingEnd,
		startColumnTime,
		endColumnTime,
...
function setRenderInfo({ uiModel, columnIndex, baseWidth, startColumnTime, endColumnTime, isDuplicateEvent = false }) {
...
function setDuplicateEvents(uiModels, options, selectedDuplicateEventCid) {
	...
	uiModels.forEach((targetUIModel) => {
		if (targetUIModel.collapse || targetUIModel.duplicateEvents.length > 0) return;
		const duplicateEvents = getDuplicateEvents(targetUIModel.model.toEventObject(), eventObjects);
		if (duplicateEvents.length <= 1) return;
		...
		const duplicateStarts = duplicateEvents.reduce((acc, { start, goingDuration }) => {
			return min(acc, addMinutes(start, -goingDuration));
		}, duplicateEvents[0].start);
		const duplicateEnds = duplicateEvents.reduce((acc, { end, comingDuration }) => {
			return max(acc, addMinutes(end, comingDuration));
...
function setRenderInfoOfUIModels(events, startColumnTime, endColumnTime, selectedDuplicateEventCid, collapseDuplicateEventsOptions) {
	...
	if (collapseDuplicateEventsOptions) setDuplicateEvents(uiModels, collapseDuplicateEventsOptions, selectedDuplicateEventCid);
	const expandedEvents = uiModels.filter((uiModel) => !uiModel.collapse);
	const uiModelColl = createEventCollection(...expandedEvents);
	const usingTravelTime = true;
	getMatrices(uiModelColl, getCollisionGroup(expandedEvents, usingTravelTime), usingTravelTime).forEach((matrix) => {
...
function TimeGrid({ timeGridData, events }) {
	const { isReadOnly, week: { narrowWeekend, startDayOfWeek, collapseDuplicateEvents } } = useStore(optionsSelector);
	const showNowIndicator = useStore(showNowIndicatorOptionSelector);
	...
	const totalUIModels = F$2(() => columns.map(({ date: date2 }) => events.filter(isBetween(toStartOfDay(date2), toEndOfDay(date2))).map((uiModel) => uiModel.clone())).map((uiModelsByColumn, columnIndex) => setRenderInfoOfUIModels(uiModelsByColumn, setTimeStrToDate(columns[columnIndex].date, first(rows).startTime), setTimeStrToDate(columns[columnIndex].date, last(rows).endTime), selectedDuplicateEventCid, collapseDuplicateEvents)), [
		columns,
		rows,
		events,
	...
	const currentDateData = F$2(() => {
		...
		return {
			startTime: setTimeStrToDate(columns[currentDateIndexInColumns].date, timeGridData.rows[0].startTime),
			endTime: setTimeStrToDate(columns[currentDateIndexInColumns].date, last(timeGridData.rows).endTime),
	...
	const updateTimeGridIndicator = T$1(() => {
		if (isPresent(currentDateData)) {
			...
			const now = getNow();
			if (startTime <= now && now <= endTime) setNowIndicatorState({
	...
	h$2(() => {
		var _a;
		if (isMounted()) if (((_a = currentDateData == null ? void 0 : currentDateData.currentDateIndex) != null ? _a : -1) >= 0) updateTimeGridIndicator();
		else setNowIndicatorState(null);
	}, [
		currentDateData,
		isMounted,
	...
	return /* @__PURE__ */ h$3("div", { className: classNames.timegrid }, /* @__PURE__ */ h$3("div", { className: classNames.scrollArea }, /* @__PURE__ */ h$3(TimeColumn, {
		timeGridRows: rows,
		nowIndicatorState
	}), /* @__PURE__ */ h$3("div", {
	...
	}, /* @__PURE__ */ h$3(GridLines, { timeGridRows: rows }), /* @__PURE__ */ h$3(MovingEventShadow$1, {
		gridPositionFinder,
		timeGridData
...
function TimezoneLabels({ top }) {
	...
	const [primaryTimezone, ...restTimezones] = timezones.map(({ displayLabel, timezoneName, tooltip }) => {
	...
	const timezoneLabelWidth = 100 / (timezonesCollapsed ? 1 : timezones.length);
	return /* @__PURE__ */ h$3("div", {
		style: {
			top,
			width
	...
	}), showTimezoneCollapseButton && /* @__PURE__ */ h$3(TimezoneCollapseButton, { isCollapsed: timezonesCollapsed }), /* @__PURE__ */ h$3(TimezoneLabel, __spreadValues({
		width: timezoneLabelWidth,
...
function getActivePanels(taskView, eventView) {
	const activePanels = [];
	if (taskView === true) activePanels.push(...DEFAULT_TASK_PANEL);
	else if (Array.isArray(taskView)) activePanels.push(...taskView);
	if (eventView === true) activePanels.push(...DEFAULT_EVENT_PANEL);
	else if (Array.isArray(eventView)) activePanels.push(...eventView);
	return activePanels;
}
function useEventsWithTimezone(events) {
	...
	const tzConverter = useTZConverter();
	return F$2(() => {
		if (primaryTimezoneName === "Local") return events;
		const isSystemUsingDST = isUsingDST(new TZDate());
		const { timedEvents = createEventCollection(), totalEvents = createEventCollection() } = events.groupBy((eventModel) => eventModel.category === "time" ? "timedEvents" : "totalEvents");
		timedEvents.each((eventModel) => {
			...
			if (isSystemUsingDST) {
				if (!isUsingDST(zonedStart)) zonedStart = zonedStart.addHours(1);
				if (!isUsingDST(zonedEnd)) zonedEnd = zonedEnd.addHours(1);
			} else {
				if (isUsingDST(zonedStart)) zonedStart = zonedStart.addHours(-1);
				if (isUsingDST(zonedEnd)) zonedEnd = zonedEnd.addHours(-1);
			}
...
function useCalendarData(calendar, ...filters) {
	const filteredEventsWithTimezone = useEventsWithTimezone(F$2(() => calendar.events.filter(Collection.and(...filters)), [calendar.events, filters]));
	return F$2(() => __spreadProps(__spreadValues({}, calendar), { events: filteredEventsWithTimezone }), [calendar, filteredEventsWithTimezone]);
}
...
function useTimezoneLabelsTop(timePanel) {
	...
	h$2(() => {
		if (isPresent(timeGridPanelHeight) && timePanel) setStickyTop(timePanel.offsetTop);
...
function Day$1() {
	...
	const dayGridEvents = F$2(() => {
		const getFilterRange = () => {
			if (primaryTimezoneName === "Local") return [toStartOfDay(days[0]), toEndOfDay(days[0])];
	...
	return /* @__PURE__ */ h$3(Layout, {
		...
		timeGridData
	}), /* @__PURE__ */ h$3(TimezoneLabels, { top: stickyTop })) : null);
}
function AccumulatedGridSelection({ rowIndex, weekDates, narrowWeekend }) {
	...
	return /* @__PURE__ */ h$3("div", { className: cls("accumulated-grid-selection") }, gridSelectionDataByRow.map((gridSelectionData) => gridSelectionData ? /* @__PURE__ */ h$3(GridSelection$1, {
		type: "accumulated",
		gridSelectionData,
		weekDates,
		narrowWeekend
...
function getDateColor({ date: date2, theme, renderDate, isToday }) {
	const dayIndex = date2.getDay();
	const isSameMonth2 = renderDate.getMonth() === date2.getMonth();
	const { common: { holiday, saturday, today, dayName }, month: { dayExceptThisMonth, holidayExceptThisMonth } } = theme;
	if (isToday) return today.color;
	if (isSunday(dayIndex)) return isSameMonth2 ? holiday.color : holidayExceptThisMonth.color;
	if (isSaturday(dayIndex)) return isSameMonth2 ? saturday.color : dayExceptThisMonth.color;
	if (!isSameMonth2) return dayExceptThisMonth.color;
...
function CellHeader({ type = CellBarType.header, exceedCount = 0, date: date2, onClickExceedCount }) {
	const { renderDate } = useStore(viewSelector);
	const [, getNow] = usePrimaryTimezone();
	...
	const gridCellDateStyle = { color: getDateColor({
		date: date2,
		theme,
		isToday,
		renderDate
...
function getSeeMorePopupSize({ grid, offsetWidth, eventLength, layerSize }) {
	...
	if (eventLength <= MAX_DISPLAY_EVENT_COUNT) height += eventHeight * eventLength;
	else height += eventHeight * MAX_DISPLAY_EVENT_COUNT;
	if (moreViewWidth) width = moreViewWidth;
	if (moreViewHeight) height = moreViewHeight;
...
function getSeeMorePopupPosition(popupSize, appContainerSize, cellRect) {
	const { width: containerWidth, height: containerHeight, left: containerLeft, top: containerTop } = appContainerSize;
	...
	if (isLeftOutOfContainer) left = containerLeft;
	if (isRightOutOfContainer) left = containerRight - popupWidth;
	if (isUpperOutOfContainer) top = containerTop;
	if (isLowerOutOfContainer) top = containerBottom - popupHeight;
	return {
		top: top + window.scrollY,
		left: left + window.scrollX
	};
}
function getSeeMorePopupRect({ layoutContainer, cell, popupSize }) {
	const popupPosition = getSeeMorePopupPosition(popupSize, layoutContainer.getBoundingClientRect(), cell.getBoundingClientRect());
...
function usePopupPosition(eventLength, parentContainer, layoutContainer) {
	...
	_$2(() => {
		if (layoutContainer && parentContainer && container) setPopupPosition(getSeeMorePopupRect({
			cell: container,
			layoutContainer,
			popupSize: getSeeMorePopupSize({
...
function GridCell({ date: date2, events = [], style, parentContainer, contentAreaHeight }) {
	...
	const onOpenSeeMorePopup = T$1(() => {
		if (popupPosition) showSeeMorePopup({
			date: date2,
			popupPosition,
			events
		});
...
var GridRow = g$1(function GridRow2({ week, rowInfo, gridDateEventModelMap = {}, contentAreaHeight }) {
	const [container, containerRefCallback] = useDOMNode();
...
function GridSelectionByRow({ weekDates, narrowWeekend, rowIndex }) {
	...
	if (isNil(gridSelectionDataByRow)) return null;
	return /* @__PURE__ */ h$3(GridSelection$1, {
		type: "month",
...
var MonthEvents = g$1(function MonthEvents2({ contentAreaHeight, eventHeight = EVENT_HEIGHT, events, name, className: className2 }) {
	...
	return /* @__PURE__ */ h$3("div", { className: className2 }, dayEvents);
});
function useDayGridMonthEventMove({ dateMatrix, rowInfo, gridPositionFinder, rowIndex }) {
	const eventBus = useEventBus();
	const { isDraggingEnd, isDraggingCanceled, draggingEvent: movingEvent, clearDraggingEvent } = useDraggingEvent("dayGrid", "move");
	const [currentGridPos, clearCurrentGridPos] = useCurrentPointerPositionInGrid(gridPositionFinder);
	const movingEventUIModel = F$2(() => {
		...
		movingEvent,
		currentGridPos == null ? void 0 : currentGridPos.rowIndex,
		currentGridPos == null ? void 0 : currentGridPos.columnIndex,
		rowIndex,
		rowInfo
	]);
	useWhen(() => {
		if (!isDraggingCanceled && isPresent(movingEventUIModel) && isPresent(currentGridPos)) {
...
function getRowPosOfUIModel(uiModel, dateRow) {
	return {
		startColumnIndex: Math.max(getGridDateIndex(uiModel.getStarts(), dateRow), 0),
		endColumnIndex: getGridDateIndex(uiModel.getEnds(), dateRow)
	};
}
function useDayGridMonthEventResize({ dateMatrix, gridPositionFinder, renderedUIModels, cellWidthMap, rowIndex }) {
	const eventBus = useEventBus();
	const { isDraggingEnd, isDraggingCanceled, draggingEvent: resizingStartUIModel, clearDraggingEvent } = useDraggingEvent("dayGrid", "resize");
	const [currentGridPos, clearCurrentGridPos] = useCurrentPointerPositionInGrid(gridPositionFinder);
	...
	_$2(() => {
		if (canCalculateProps && rowIndex === baseResizingInfo.eventStartDateRowIndex) {
			...
			let height;
			if (eventStartDateRowIndex === currentGridPos.rowIndex) height = cellWidthMap[eventStartDateColumnIndex][Math.max(eventStartDateColumnIndex, currentGridPos.columnIndex)];
			else if (eventStartDateRowIndex > currentGridPos.rowIndex) height = cellWidthMap[eventStartDateColumnIndex][eventStartDateColumnIndex];
			else {
	...
	_$2(() => {
		if (canCalculateProps && rowIndex > baseResizingInfo.eventStartDateRowIndex && rowIndex > currentGridPos.rowIndex) setGuideProps(null);
	}, [
		canCalculateProps,
		currentGridPos,
		baseResizingInfo,
	...
	useWhen(() => {
		if (canCalculateProps) {
			...
			if (!isDraggingCanceled && (currentGridPos.rowIndex === eventStartDateRowIndex && currentGridPos.columnIndex >= eventStartDateColumnIndex || currentGridPos.rowIndex > eventStartDateRowIndex)) {
				const targetEndDate = dateMatrix[currentGridPos.rowIndex][currentGridPos.columnIndex];
				eventBus.fire("beforeUpdateEvent", {
					event: resizingStartUIModel.model.toEventObject(),
					changes: { end: targetEndDate }
				});
			}
		}
		clearStates();
...
function ResizingGuideByRow({ dateMatrix, cellWidthMap, gridPositionFinder, renderedUIModels, rowIndex }) {
	...
	if (isNil(resizingGuideProps)) return null;
	const [uiModel, resizingWidth] = resizingGuideProps;
	return /* @__PURE__ */ h$3("div", { className: cls("weekday-events") }, /* @__PURE__ */ h$3(HorizontalEvent, {
...
function DayGridMonth({ dateMatrix = [], rowInfo = [], cellWidthMap = [] }) {
	...
	const renderedEventUIModels = F$2(() => dateMatrix.map((week) => getRenderedEventUIModels(week, calendarData, narrowWeekend)), [
		calendarData,
		dateMatrix,
		narrowWeekend
	]);
	...
	return /* @__PURE__ */ h$3("div", {
		...
		return /* @__PURE__ */ h$3("div", {
			...
			ref
		}, /* @__PURE__ */ h$3("div", { className: cls("weekday") }, /* @__PURE__ */ h$3(GridRow, {
			gridDateEventModelMap,
			week,
			rowInfo,
...
function getMonthDayNames(options) {
	...
	return [...Array(7)].map((_2, i2) => (startDayOfWeek + i2) % 7).map((i2) => ({
		day: i2,
		label: capitalize(dayNames[i2])
	})).filter((dayNameInfo) => workweek ? !isWeekend(dayNameInfo.day) : true);
}
function Month$1() {
	const options = useStore(optionsSelector);
	const { renderDate } = useStore(viewSelector);
	...
	const { rowStyleInfo, cellWidthMap } = F$2(() => getRowStyleInfo(dayNames.length, narrowWeekend, startDayOfWeek, workweek), [
		dayNames.length,
		narrowWeekend,
		startDayOfWeek,
		workweek
	]);
	const rowInfo = rowStyleInfo.map((cellStyleInfo, index) => __spreadProps(__spreadValues({}, cellStyleInfo), { date: dateMatrix[0][index] }));
	return /* @__PURE__ */ h$3(Layout, { className: cls("month") }, /* @__PURE__ */ h$3(GridHeader, {
		type: "month",
		dayNames,
...
function Week$1() {
	...
	const eventByPanel = F$2(() => {
		const getFilterRange = () => {
			if (primaryTimezoneName === "Local") return [toStartOfDay(first(weekDates)), toEndOfDay(last(weekDates))];
...
function Main() {
	const { currentView } = useStore(viewSelector);
	return /* @__PURE__ */ h$3(F$2(() => views[currentView] || (() => null), [currentView]), null);
}
...
function x(r2, n2, l2, c2, g2, h2) {
	...
	if (typeof w2 == "function") {
		if (C2 = true, !l2.shallow || !c2 && l2.renderRootComponent !== false) {
			...
			if (w2.prototype && typeof w2.prototype.render == "function") {
				...
				(j2 = r2.__c = new w2(O2, $2)).__v = r2, j2._dirty = j2.__d = true, j2.props = O2, j2.state ?? (j2.state = {}), j2._nextState == null && j2.__s == null && (j2._nextState = j2.__s = j2.state), j2.context = $2, w2.getDerivedStateFromProps ? j2.state = f(f({}, j2.state), w2.getDerivedStateFromProps(j2.props, j2.state)) : j2.componentWillMount && (j2.componentWillMount(), j2.state = j2._nextState !== j2.state ? j2._nextState : j2.__s !== j2.state ? j2.__s : j2.state), F2 && F2(r2), H2 = j2.render(j2.props, j2.state, j2.context);
		...
		for (var q2 = 0; q2 < W2.length; q2++) {
			...
			if (z2 !== "children") {
				if (!d.test(z2) && (l2 && l2.allAttributes || z2 !== "key" && z2 !== "ref" && z2 !== "__self" && z2 !== "__source")) {
					if (z2 === "defaultValue") z2 = "value";
					else if (z2 === "defaultChecked") z2 = "checked";
					else if (z2 === "defaultSelected") z2 = "selected";
					...
					if (V2 || V2 === "") U2 += V2;
					else if (z2 === "dangerouslySetInnerHTML") R2 = I2 && I2.__html;
					else if (w2 === "textarea" && z2 === "value") P2 = I2;
	...
	if (J2.length || R2) U2 += J2.join("");
	else if (l2 && l2.xml) return U2.substring(0, U2.length - 1) + " />";
...
function isExpired(date2) {
	return (/* @__PURE__ */ new Date()).getTime() - date2 > ms7days;
}
function sendHostname(appName, trackingId) {
	var url = "https://www.google-analytics.com/collect";
	var hostname = location.hostname;
	...
	if (!isUndefined$1(window.tui) && window.tui.usageStatistics === false) return;
	if (date2 && !isExpired(date2)) return;
	window.localStorage.setItem(applicationKeyForStorage, (/* @__PURE__ */ new Date()).getTime());
	setTimeout(function() {
		if (document.readyState === "interactive" || document.readyState === "complete") imagePing(url, {
			v: 1,
...
function CalendarContainer({ theme, store, eventBus, children }) {
	return /* @__PURE__ */ h$3(EventBusProvider, { value: eventBus }, /* @__PURE__ */ h$3(ThemeProvider, { store: theme }, /* @__PURE__ */ h$3(StoreProvider, { store }, /* @__PURE__ */ h$3(FloatingLayerProvider, null, children))));
}
...
function forEach$1(obj, iteratee, context) {
	if (isArray$1(obj)) forEachArray(obj, iteratee, context);
	else forEachOwnProperties(obj, iteratee, context);
}
...
CustomEvents.prototype._spliceMatches = function(arr, predicate) {
	...
	var len;
	if (!isArray(arr)) return;
	for (len = arr.length; i2 < len; i2 += 1) if (predicate(arr[i2]) === true) {
		arr.splice(i2, 1);
		len -= 1;
		i2 -= 1;
	}
...
CustomEvents.prototype._matchHandler = function(handler) {
	...
	return function(item) {
		var needRemove = handler === item.handler;
		if (needRemove) self2._forgetContext(item.context);
		return needRemove;
	};
};
CustomEvents.prototype._matchContext = function(context) {
...
CustomEvents.prototype._offByEventName = function(eventName, handler) {
	...
	forEach(eventName, function(name) {
		...
		if (andByHandler) self2._spliceMatches(handlerItems, matchHandler);
		else {
			forEach(handlerItems, function(item) {
...
var EventBusImpl = class extends customEvents {
...
var CalendarCore = class {
	constructor(container, options = {}) {
		...
		addAttributeHooks();
		if (this.getStoreState().options.usageStatistics === true) sendHostname_1("calendar", GA_TRACKING_ID);
	}
	getStoreState(group) {
	...
	destroy() {
		if (this.container) un(this.container);
	...
	calculateMonthRenderDate({ renderDate, offset, monthOptions }) {
		let newRenderDate = new TZDate(renderDate);
		const { visibleWeeksCount } = monthOptions;
		if (visibleWeeksCount > 0) newRenderDate = addDate(newRenderDate, offset * 7 * visibleWeeksCount);
		else newRenderDate = addMonths(newRenderDate, offset);
	...
	calculateWeekRenderDate({ renderDate, offset, weekOptions }) {
	...
	calculateDayRenderDate({ renderDate, offset }) {
		...
		return {
			renderDate: newRenderDate,
			renderRange: {
				start: toStartOfDay(newRenderDate),
				end: toEndOfDay(newRenderDate)
			}
		};
	}
	move(offset) {
		if (isNil(offset)) return;
		...
		if (currentView === "month") calculatedRenderDate = this.calculateMonthRenderDate({
			renderDate,
			offset,
			monthOptions: options.month
		});
		else if (currentView === "week") calculatedRenderDate = this.calculateWeekRenderDate({
			renderDate,
			offset,
			weekOptions: options.week
		});
		else if (currentView === "day") calculatedRenderDate = this.calculateDayRenderDate({
			renderDate,
			offset
		});
	...
	deleteEvent(eventId, calendarId) {
		...
		const event = this.getEventModel(eventId, calendarId);
		if (event) deleteEvent2(event);
	}
	setCalendarVisibility(calendarId, isVisible) {
		const { setCalendarVisibility } = this.getStoreDispatchers("calendar");
		setCalendarVisibility(Array.isArray(calendarId) ? calendarId : [calendarId], isVisible);
	}
	render() {
		if (isPresent(this.container)) P$2(/* @__PURE__ */ h$3(CalendarContainer, {
			theme: this.theme,
			store: this.store,
	...
	calculateRenderRange(renderDate) {
		...
		if (currentView === "month") newRenderRange = this.calculateMonthRenderDate({
			renderDate,
			offset: 0,
			monthOptions: options.month
		}).renderRange;
		else if (currentView === "week") newRenderRange = this.calculateWeekRenderDate({
			renderDate,
			offset: 0,
			weekOptions: options.week
		}).renderRange;
		else if (currentView === "day") newRenderRange = this.calculateDayRenderDate({
			renderDate,
			offset: 0
		}).renderRange;
	...
	getElement(eventId, calendarId) {
		if (this.getEvent(eventId, calendarId) && this.container) return this.container.querySelector(`[data-event-id="${eventId}"][data-calendar-id="${calendarId}"]`);
		return null;
	}
	setTheme(theme) {
	...
	setOptions(options) {
		...
		const { setTheme } = this.theme.getState().dispatch;
		const { options: { setOptions }, template: { setTemplate } } = this.getStoreDispatchers();
		if (isPresent(theme)) setTheme(theme);
		if (isPresent(template)) setTemplate(template);
...
var Calendar = class extends CalendarCore {
	constructor(container, options = {}) {
		...
		if (!isValidViewType(defaultView)) throw new InvalidViewTypeError(defaultView);
		this.render();
	}
	getComponent() {
...
var Day = class extends CalendarCore {
	constructor(container, options = {}) {
		super(container, options);
		this.render();
	}
...
var Month = class extends CalendarCore {
	constructor(container, options = {}) {
		super(container, options);
		this.render();
	}
...
var Week = class extends CalendarCore {
	constructor(container, options = {}) {
		super(container, options);
		this.render();
	}
...
//# sourceMappingURL=@toast-ui_calendar.js.map